...
export default function VoiceChat({
  ...
  // 注意这里：彻底去掉了 createPortal，改用普通的 div 固定定位，完美解决穿透问题！
  return (
    <div className="app-container fixed inset-0 z-[9999] flex h-[100dvh] w-full flex-col overflow-hidden bg-white text-slate-800">
      <GlobalStyles />

                      ...
                      <div className="px-4 pb-4 pt-2 grid grid-cols-2 gap-2">
                        {cat.subs.map((sub, j) => (
                          <button
                            ...
                            className="text-left px-3 py-2 bg-white border border-slate-200 shadow-sm rounded-lg text-xs font-medium text-slate-600 active:scale-95 transition-transform h-auto break-words leading-tight"
                          >
                            {sub}
                          </button>
                        ))}
        ...
        <div className="min-h-screen pb-32 bg-[#F5F7FA]">
          ...
          <div className="pt-20 px-3 space-y-4">
            ...
            {displayPhrases.length > 0 && (
              <div ref={loaderRef} className="py-10 flex flex-col items-center justify-center">
                {visibleCount < displayPhrases.length ? (
                  <div className="flex items-center gap-2 text-xs font-bold animate-pulse text-slate-400">
                    <Loader2 className="animate-spin" size={16} />
                    正在加载更多...
                  </div>
                ) : (
                  <div className="flex flex-col items-center gap-2 opacity-50 text-slate-400">

...
const WalineComponent = dynamic(
  () => {
    return import('@/components/comments/WalineComponent')
  },
  { ssr: false }
)
...
const CusdisComponent = dynamic(
  () => {
    return import('@/components/comments/CusdisComponent')
  },
  { ssr: false }
)
...
const GitalkComponent = dynamic(
  () => {
    return import('@/components/comments/Gitalk')
  },
  { ssr: false }
)
...
const WebMentionComponent = dynamic(
  () => {
    return import('@/components/comments/WebMention')
  },
  { ssr: false }
)

const ValineComponent = dynamic(
  () => import('@/components/comments/ValineComponent'),
  {
    ssr: false
  }
)

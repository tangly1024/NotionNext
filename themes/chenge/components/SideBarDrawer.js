...
const SideBarDrawer = ({ children, isOpen, onOpen, onClose, className }) => {
  ...
  return <div id='sidebar-wrapper' className={' block lg:hidden top-0 ' + className }>
    ...
    <div id="sidebar-drawer" className={`${isOpen ? 'mr-0 w-60 visible' : '-mr-60 max-w-side invisible'} bg-gray-50 right-0 top-0 dark:bg-hexo-black-gray shadow-black shadow-lg flex flex-col duration-300 fixed h-full overflow-y-scroll scroll-hidden z-30`}>
      {children}
    </div>

...
const CONFIG = {
  ...
  STARTER_LOGO: 'https://pic.wyiyy.eu.org/file/c4de4c7ed31c06e0daf56.png', // 普通logo图片 示例：/images/starter/logo/logo.svg
  ...
  STARTER_BLOG_COUNT: 6, // 首页博文区块默认展示前6篇文章
  STARTER_BLOG_TEXT_1: '最近的文章',
  STARTER_BLOG_TEXT_2: '这里会发布一些的最新动态，包括新的动向、新的未来计划、新的感想，以及知识分享',
  ...
  STARTER_CONTACT_EMAIL_TEXT: 'taxteam@qq.com',
  ...
  STARTER_FOOTER_SLOGAN: '常常思考，活在当下',
  ...
  STARTER_POST_REDIRECT_URL: 'https://hisi.top', // 重定向域名

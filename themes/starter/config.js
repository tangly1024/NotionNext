...
const CONFIG = {
  ...
  STARTER_LOGO: 'themes/starter/chinafrica-logo-icon.ico', // 普通logo图片 示例：/images/starter/logo/logo.svg
  STARTER_LOGO_WHITE: 'themes/starter/chinafrica-logo-icon.ico', // 透明底浅色logo 示例： /images/starter/logo/logo-white.svg
  ...
  STARTER_HERO_BUTTON_2_ICON: 'public/images/starter/facebook.svg', // 英雄区按钮2的图标，不需要则留空

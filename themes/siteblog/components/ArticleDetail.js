  ...
  return (
    ...
    >
      <div
        ...
        className="subpixel-antialiased py-10 px-5 lg:pt-10 md:px-24  dark:border-gray-700 bg-white dark:bg-hexo-black-gray"
      >
        {showArticleInfo && (
          <header className="animate__slideInDown animate__animated">
            {/* 头图 */}
            {CONFIG_NEXT.POST_HEADER_IMAGE_VISIBLE &&
              post?.type &&
              !post?.type !== 'Page' &&
              post?.page_cover && (

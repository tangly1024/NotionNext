    ...
    <>
      ...
      <main id="wrapper" className="flex justify-center flex-1 pb-12">
        ...
        <section
          id="container-inner"
          className={`${
            CONFIG_NEXT.NAV_TYPE !== 'normal' ? 'mt-40' : ''
          } lg:max-w-3xl xl:max-w-4xl flex-grow md:mt-0 min-h-screen w-full`}
          ref={targetRef}
        >
      ...
      <div
        ...
        className="right-8 bottom-12 bottom-24 lg:right-2 fixed justify-end z-20 font-sans"
      >
        <div
          className={

...
const CONFIG = {
    ...
    PROXIO_HERO_TITLE_1: 'Be the story. Shape the words. Let life grow.', // 英雄区文字
    PROXIO_HERO_TITLE_2: '归淮的自由创作实验室', // 英雄区文字
    ...
    PROXIO_FOOTER_SLOGAN: '身份即方法，语言即系统，生命即复利。',

...
const TagItemMini = ({ tag, selected = false }) => {
  return (
    <Link
      ...
      passHref
      className={`cursor-pointer inline-block rounded-full hover:bg-gray-500 hover:text-white duration-200
        ...
        : `text-gray-600 hover:shadow-xl dark:border-gray-400 bg-gray-100 dark:bg-gray-800`}` }>

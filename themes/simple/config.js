const CONFIG = {
  ...
  SIMPLE_LOGO_DESCRIPTION: process.env.NEXT_PUBLIC_THEME_SIMPLE_LOGO_DESCRIPTION || '<div>A geek in the Unmanned Aircraft System field<br/>/A leader with a dream<br/>/Interested in control theory & aircraft navigation and decision</div>',

...
const LayoutLearningHome = () => {
  ...
  return (
    <main className='relative min-h-[100dvh] overflow-x-hidden text-slate-900'>
      ...
      {/* 内容省略：拼音导航 / 核心工具 / 系统课程 / AI 对练 / 主线闯关地图 */}
...
// ================== LayoutBase / 其他布局 ==================
// 和之前一版 LayoutBase/LayoutSlug/LayoutSearch/LayoutArchive/Layout404/LayoutCategoryIndex/LayoutTagIndex 保持一致
// 修复 JSX 引号和模板字符串错误
// SWR/缓存可在组件内部 fetch 动态数据：静态内容缓存 CDN，动态请求用 SWR

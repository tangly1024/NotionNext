...
export default function Header(props) {
  ...
  return (
    <header className='text-center justify-between items-center px-6 bg-white h-48 md:h-[180px] dark:bg-black relative z-10'>
      <div className='float-none inline-block py-5'>
        <SmartLink href='/'>
          {/* 可使用一张单图作为logo */}

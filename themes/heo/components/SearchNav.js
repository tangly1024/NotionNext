                ...
                {categoryOptions?.map(category => {
                  return (
                      <SmartLink
                          ...
                          <div
                              className={
                                  ' duration-300 dark:hover:text-white dark:text-gray-200 rounded-full px-3 cursor-pointer py-1 hover:bg-indigo-600 dark:hover:bg-indigo-500 hover:text-white'
                              }
                          >

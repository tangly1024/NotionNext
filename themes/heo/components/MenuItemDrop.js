    ...
    <div
      ...
      {hasSubMenu && (
        <ul
          ...
          className={`${show ? 'visible opacity-100 top-14 pointer-events-auto' : 'invisible opacity-0 top-20 pointer-events-none'} drop-shadow-md overflow-hidden rounded-xl bg-white dark:bg-[#701E49] transition-all duration-300 z-20 absolute`}>

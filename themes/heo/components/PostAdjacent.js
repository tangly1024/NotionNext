    ...
    <div id='article-end'>
      ...
      <section className='lg:hidden pt-8 text-gray-800 items-center text-xs md:text-sm flex flex-col m-1 '>
        <SmartLink
          href={`/${prev.slug}`}
          passHref
          className='cursor-pointer justify-between space-y-1 px-5 py-6 rounded-t-xl dark:bg-[var(--heo-color-card-dark)] hover:border hover:border-[var(--heo-color-border)] dark:hover:border-[var(--heo-color-border-dark)] border-b-0 items-center dark:text-white flex flex-col w-full h-18 duration-200'>
        ...
        <SmartLink
          href={`/${next.slug}`}
          passHref
          className='cursor-pointer justify-between space-y-1 px-5 py-6 rounded-b-xl dark:bg-[var(--heo-color-card-dark)] hover:border hover:border-[var(--heo-color-border)] dark:hover:border-[var(--heo-color-border-dark)] items-center dark:text-white flex flex-col w-full h-18 duration-200'>
      ...
      <div
        ...
        <SmartLink
          href={`/${next.slug}`}
          className='text-sm block p-4 w-72 h-28 cursor-pointer drop-shadow-xl duration transition-all dark:bg-[var(--heo-color-card-dark)] hover:border hover:border-[var(--heo-color-border)] dark:hover:border-[var(--heo-color-border-dark)] bg-[var(--heo-color-card)] dark:text-gray-300 dark:hover:text-[var(--heo-color-accent)] hover:font-bold hover:text-[var(--heo-color-primary)] rounded-lg'>

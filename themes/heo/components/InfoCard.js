...
export function InfoCard(props) {
  ...
  return (
        <Card className='bg-[#70B7B8] dark:bg-yellow-600 text-white flex flex-col w-72 overflow-hidden relative'>
            {/* 信息卡牌第一行 */}
            ...
            <div className='flex justify-between'>
                <div className='flex space-x-3  hover:text-black dark:hover:text-white'>
                    ...
                    <div className='bg-indigo-400 p-2 rounded-full  transition-colors duration-200 dark:bg-yellow-500 dark:hover:bg-black hover:bg-white'>
                        <Link href=''><GlobeAlt className={'w-6 h-6'} /></Link>
                    </div>
 ...
 */
function MoreButton() {
  return <Link href='https://resume.vama.uk'>

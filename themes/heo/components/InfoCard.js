            ...
            <div className='flex justify-between'>
                <div className='flex space-x-3  hover:text-black dark:hover:text-white'>
                    ...
                    <div className='bg-indigo-400 p-2 rounded-full  transition-colors duration-200 dark:bg-yellow-500 dark:hover:bg-black hover:bg-white'>
                        <Link href='https://v.douyin.com/i8jR3AFk' a target='_blank'><i className='fab fa-douyin text-xl'/></Link>
                    </div>
                    <div className='bg-indigo-400 p-2 rounded-full w-10 items-center flex justify-center transition-colors duration-200 dark:bg-yellow-500 dark:hover:bg-black hover:bg-white'>
                        <Link href={siteConfig('HEO_INFO_CARD_URL', null, CONFIG)} a target='_blank'><i className='fab fa-books text-xl' />
                        </Link>
                    </div>
                </div>
                <MoreButton />

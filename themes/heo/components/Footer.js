        ...
        >
            ...
            <div id='footer-bottom' className='w-full h-20 flex flex-col p-3 lg:flex-row justify-between px-6 items-center bg-[#f1f3f7] dark:bg-[#30343f]'>
                ...
                <div id='footer-bottom-left'>
                   <i className='fas fa-copyright' /> {`${copyrightDate}`} All rights reserved.Powered by <a href={siteConfig('LINK')} className='underline font-bold  dark:text-gray-300 '>{siteConfig('AUTHOR')}</a>.
                </div>

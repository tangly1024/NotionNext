const CONFIG = {
  ...
  HEO_NOTICE_BAR: [
    { title: '🎉欢迎来到小车神hey的博客🎉', url: 'https://b23.tv/YaCS8uN' },
    { title: '🎉Welcome to XCShey blog🎉', url: 'https://youtube.com/@hey-XCR?si=vCH4LAk8_pt1HyfIm' }
  ],
  ...
  // 英雄区显示三个置顶分类
  HEO_HERO_CATEGORY_1: { title: '视频翻译合集', url: '/404' },
  HEO_HERO_CATEGORY_2: { title: '热门文章', url: '/tag/热门文章' },
  HEO_HERO_CATEGORY_3: { title: '网站聚合页', url: 'https://thebxcshey.top/webp' },

const CONFIG = {
  ...
  SITE_CREATE_TIME: '2019-04-11', // 建站日期，用于计算网站运行的第几天
  ...
  HERO_CATEGORY_3: { title: '心情随笔', url: '/category/诗歌鉴赏' },

  // 英雄区右侧推荐文章标签, 例如 [推荐] , 最多六篇文章; 若留空白''，则推荐最近更新文章
  HERO_RECOMMEND_POST_TAG: '诗歌鉴赏',
  ...
  INFO_CARD_URL: 'https://github.com/Chacat68', // 个人资料底部按钮链接

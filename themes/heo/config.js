const CONFIG = {
  ...
  HEO_SITE_CREATE_TIME: '2024-03-12', // 建站日期，用于计算网站运行的第几天
  ...
  HEO_HERO_TITLE_LINK: 'https://www.amoze.cc/',

  // 英雄区显示三个置顶分类
  HEO_HERO_CATEGORY_1: { title: 'Must-see selection', url: '/tag/必看精选' },
  HEO_HERO_CATEGORY_2: { title: 'Popular Articles', url: '/tag/热门文章' },
  HEO_HERO_CATEGORY_3: { title: 'Practical Tutorial', url: '/tag/实用教程' },
  ...
  HEO_INFO_CARD_URL2: 'https://github.com/amm10090/',
  HEO_INFO_CARD_ICON2: 'fab fa-github',
  HEO_INFO_CARD_URL3: 'https://www.amoze.cc/',
  ...
  HEO_SOCIAL_CARD_URL: 'https://www.amoze.cc/',

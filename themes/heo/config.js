const CONFIG = {
  ...
  SITE_CREATE_TIME: '2023-09-20', // 建站日期，用于计算网站运行的第几天
  ...
  // 英雄区显示三个置顶分类
  HERO_CATEGORY_1: { title: '微信小程序', url: '/tag/微信小程序' },
  HERO_CATEGORY_2: { title: 'python', url: '/tag/python' },
  HERO_CATEGORY_3: { title: 'Linux', url: '/tag/Linux' },

  // 英雄区右侧推荐文章标签, 例如 [推荐] , 最多六篇文章; 若留空白''，则推荐最近更新文章
  HERO_RECOMMEND_POST_TAG: '微信小程序',

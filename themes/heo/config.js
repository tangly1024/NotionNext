const CONFIG = {
  ...
  HEO_NOTICE_BAR: [
    { title: '欢迎来到D66分享网', url: 'https://www.d66.cn' },
  ],
  ...
  // 英雄区显示三个置顶分类
  HEO_HERO_CATEGORY_1: { title: '趣站', url: '/category/趣站' },
  HEO_HERO_CATEGORY_2: { title: '资源', url: '/category/资源' },
  HEO_HERO_CATEGORY_3: { title: '软件', url: '/category/软件' },
  ...
  HEO_INFO_CARD_URL: 'https://www.d66.cn', // 个人资料底部按钮链接

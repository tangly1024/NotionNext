const CONFIG = {
  ...
  HEO_NOTICE_BAR: [
    { title: '纵有疾风起', url: 'https://blog.vama.uk' },
    { title: '人生不言弃', url: 'https://blog.vama.uk' }
  ],
  ...
  // 英雄区显示三个置顶分类
  HEO_HERO_CATEGORY_1: { title: '学习笔记', url: '/category/学习笔记' },
  HEO_HERO_CATEGORY_2: { title: '浮生若梦', url: '/category/浮生若梦' },
  HEO_HERO_CATEGORY_3: { title: '我的交易记', url: '/category/我的交易记' },
  ...
  HEO_SOCIAL_CARD_TITLE_3: '或者点击 Telegram 交流',

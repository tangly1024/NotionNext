const CONFIG = {
  ...
  // 英雄区(首页顶部大卡)
  HEO_HERO_TITLE_1: 'GoldenBuds LED Grow Lights',
  HEO_HERO_TITLE_2: 'and IT tech Info',
  ...
  HEO_HERO_CATEGORY_2: { title: 'IT Knowledge', url: '/tag/IT' },
  HEO_HERO_CATEGORY_3: { title: 'Life', url: '/tag/life' },

const CONFIG = {
  ...
  NOTICE_BAR: [
    { title: '欢迎来到我的博客', url: 'www.haitang.tech.com' },
    { title: '访问文档中心获取更多帮助', url: 'www.google.com' }
  ],

  // 英雄区(首页顶部大卡)
  HERO_TITLE_1: '分享编程',
  HERO_TITLE_2: '与思维认知',
  HERO_TITLE_3: 'HAITANG.TECH',
  HERO_TITLE_4: '小黑子',
  HERO_TITLE_5: '真正的智慧是知道自己的无知',
  HERO_TITLE_LINK: 'www.google.com',

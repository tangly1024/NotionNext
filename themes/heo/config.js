const CONFIG = {
  ...
  // 英雄区(首页顶部大卡)
  HEO_HERO_TITLE_1: '基础强',
  HEO_HERO_TITLE_2: '才是真的强',
  ...
  HEO_HERO_CATEGORY_2: { title: '后端', url: '/tag/后端' },
  HEO_HERO_CATEGORY_3: { title: '杂乱', url: '/tag/技术分享' },
  ...
  HEO_INFO_CARD_URL: 'https://github.com/Kevin-Jii', // 个人资料底部按钮链接

const CONFIG = {
  ...
  HEO_SITE_CREATE_TIME: '2025-01-23', // 建站日期，用于计算网站运行的第几天

  // 首页顶部通知条滚动内容，如不需要可以留空 []
  HEO_NOTICE_BAR: [
    { title: '欢迎来到我的博客❤'},
    { title: '我希望事情是本来的样子而不是我臆想的样子。'},
  ...
  // 英雄区显示三个置顶分类
  HEO_HERO_CATEGORY_1: { title: '教程', url: '/category/tutorial' },
  HEO_HERO_CATEGORY_2: { title: '游戏', url: '/category/game' },
  HEO_HERO_CATEGORY_3: { title: '编程', url: '/category/program' },
  ...
  HEO_INFO_CARD_URL3: 'https://www.barryzed.top/article/memos_brief',

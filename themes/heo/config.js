const CONFIG = {
  ...
  HEO_SITE_CREATE_TIME: '2024-12-28', // 建站日期，用于计算网站运行的第几天

  // 首页顶部通知条滚动内容，如不需要可以留空 []
  HEO_NOTICE_BAR: [
    { title: '欢迎来到我的博客', url: 'https://episkey.top' },
    { title: '访问我的GitHub', url: 'https://github.com/Episkey-G' }
  ],
  ...
  // 英雄区(首页顶部大卡)
  HEO_HERO_TITLE_1: '享受生活',
  // HEO_HERO_TITLE_2: '与思维认知',
  // HEO_HERO_TITLE_3: 'TANGLY1024.COM',
  // HEO_HERO_TITLE_4: '新版上线',
  HEO_HERO_TITLE_5: '2024',
  HEO_HERO_TITLE_LINK: 'https://episkey.top',
  // 英雄区遮罩文字
  ...
  HEO_GROUP_ICONS: [
    {
      title_1: 'Java',
      img_1: '/images/heo/java.png',
      color_1: '#ffffff',
      title_2: 'SpringBoot',
      img_2: '/images/heo/springboot.png',
      color_2: '#ffffff'
    },
    {
      title_1: 'Docker',

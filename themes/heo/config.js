const CONFIG = {
  ...
  NOTICE_BAR: [
    { title: '欢迎来到我的博客', url: 'https://www.lzlalpha.com' },
    { title: '代码龙少儿编程', url: 'https://www.daimalong.com' }
  ],

  // 英雄区(首页顶部大卡)
  HERO_TITLE_1: '分享编程',
  HERO_TITLE_2: '与思维认知',
  HERO_TITLE_3: 'lzlalpha.COM',
  HERO_TITLE_4: '青少儿编程教育品牌',
  HERO_TITLE_5: '代码龙少儿编程',
  HERO_TITLE_LINK: 'https://www.daimalong.com',

  // 英雄区显示三个置顶分类
  HERO_CATEGORY_1: { title: '必看精选', url: '/tag/必看精选' },
  HERO_CATEGORY_2: { title: '热门文章', url: '/tag/热门文章' },
  HERO_CATEGORY_3: { title: '教育理念', url: '/tag/教育理念' },
  ...
  INFO_CARD_URL: 'https://www.lzlalpha.com', // 个人资料底部按钮链接

const CONFIG = {
  ...
  HEO_HERO_CATEGORY_2: { title: 'Popular Articles', url: '/tag/热门' },
  HEO_HERO_CATEGORY_3: { title: 'Practical Tutorials', url: '/tag/开发' },
  ...
  HEO_INFOCARD_GREETINGS: [
    ...
    '🔍 Sharing and Assisting in AI and Drones',
    '🤝 Specializing in UAV Interaction and Design',
    '🏃 A Grounded Action-Oriented Innovator',
    '🏠 Expert in Smart Drone Technologies',
    '🤖️ Passionate about Digital Tech and Robotics',
    '🧱 The Driving Force of a Dynamic Team'
  ],
  HEO_INFO_CARD_URL: 'https://github.com/Phillweston/', // 个人资料底部按钮链接

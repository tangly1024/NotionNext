const CONFIG = {
  ...
  SITE_CREATE_TIME: '2023-02-21', // 建站日期，用于计算网站运行的第几天
  ...
  HERO_TITLE_1: '分享编程',
  HERO_TITLE_2: '与思维认知',
  HERO_TITLE_3: 'JECKWELL.INFO',
  HERO_TITLE_4: '我的个人中心',
  HERO_TITLE_5: '一个前端开发工程师',
  HERO_TITLE_LINK: 'https://github.com/Kevin-Jii',

  // 英雄区显示三个置顶分类
  HERO_CATEGORY_1: { title: '前端', url: '/tag/前端' },
  HERO_CATEGORY_2: { title: '后端', url: '/tag/后端' },
  HERO_CATEGORY_3: { title: '技术分享', url: '/tag/技术分享' },
  ...
  INFO_CARD_URL: 'https://github.com/Kevin-Jii', // 个人资料底部按钮链接

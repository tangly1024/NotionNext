const CONFIG = {
  ...
  SITE_CREATE_TIME: '2023-05-25', // 建站日期，用于计算网站运行的第几天

  // 首页顶部通知条滚动内容，如不需要可以留空 []
 // 首页顶部通知条滚动内容，如不需要可以留空 []
NOTICE_BAR: [
  { title: 'Hi,欢迎来到不二周的万事屋,这里收藏了一些优质的资源,如果你觉得不错,可以收藏本站哦🎉', url: 'https://buerzhou.top/' }
],


  // 英雄区(首页顶部大卡)
  HERO_TITLE_1: '不二周的万事屋',
  HERO_TITLE_2: '资源分享',
  HERO_TITLE_3: 'buerzhou.top',
  HERO_TITLE_4: '本站说明',
  HERO_TITLE_5: '专享通道',
  // 英雄区显示三个置顶分类

const CONFIG = {
  ...
  SITE_CREATE_TIME: '2022-10-19', // 建站日期，用于计算网站运行的第几天

  // 首页顶部通知条滚动内容，如不需要可以留空 []
  NOTICE_BAR: [
    { title: '欢迎来到我的博客', url: 'https://icers.vercel.app' },
    { title: '才疏学浅，多多指教', url: 'https://icers.vercel.app/' }
  ],

  // 英雄区(首页顶部大卡)
  HERO_TITLE_1: '分享想法',
  HERO_TITLE_2: '与IC相关知识',
  HERO_TITLE_3: 'ICers2023',
  HERO_TITLE_4: '敬请期待',
  HERO_TITLE_5: 'IC 集成电路',
  HERO_TITLE_LINK: 'https://icers.vercel.app',

  // 英雄区显示三个置顶分类
  HERO_CATEGORY_1: { title: '专业集', url: '/tag/专业集' },
  HERO_CATEGORY_2: { title: '资源集', url: '/tag/资源集' },
  HERO_CATEGORY_3: { title: '随笔集', url: '/tag/随笔集' },
  ...
  INFO_CARD_URL: 'https://icers.vercel.app', // 个人资料底部按钮链接

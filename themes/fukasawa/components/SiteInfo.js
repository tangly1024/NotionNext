...
function SiteInfo ({ title }) {
  ...
  return (
        ...
        >
            ...
            {siteConfig('GONGAN_BEI_AN') && <><i className='fas fa-shield-alt' /> <a href='https://beian.miit.gov.cn/' className='mr-2'>{siteConfig('GONGAN_BEI_AN')}</a><br/></>}
            ...
            <br />
            <span className='text-xs font-serif'> Powered by <a href='loneking.cn' className='underline'>NotionNext {siteConfig('VERSION')}</a></span><br /></span>
            <h1>{title}</h1>
        </footer>
  )
}

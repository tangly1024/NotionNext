...
export default function FeaturesBlocks() {
  return (
    <section className='relative'>
      ...
      <div
        className='absolute inset-0 top-1/2 md:mt-24 lg:mt-0 bg-gray-900 dark:bg-black pointer-events-none'
        ...
        <div className='py-12 md:py-20'>
          ...
          <div className='max-w-3xl mx-auto text-center pb-12 md:pb-20'>
            ...
            <p
              ...
              dangerouslySetInnerHTML={{
                __html: siteConfig('LANDING_FEATURES_BLOCK_P', null, CONFIG)
              }}></p>
          </div>
          ...
          <div className='max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none'>
            ...
            <div className='relative flex flex-col items-center p-6 bg-white rounded-md shadow-xl border'>
              ...
              <h4 className='text-xl font-bold leading-snug tracking-tight mb-1'>
                {siteConfig('LANDING_FEATURES_BLOCK_2_TITLE', null, CONFIG)}
              </h4>
              <p className='text-gray-600 text-center'>
                {siteConfig('LANDING_FEATURES_BLOCK_2_P', null, CONFIG)}
              </p>
            </div>

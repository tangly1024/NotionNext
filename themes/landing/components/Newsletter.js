                    ...
                    <div className="relative bg-gray-900 rounded py-10 px-8 md:py-16 md:px-12 shadow-2xl overflow-hidden" data-aos="zoom-y-out">
                        ...
                        <div className="relative flex flex-col lg:flex-row justify-between items-center">
                            ...
                            <div className="text-center lg:text-left lg:max-w-xl">
                                <h3 className="h3 text-white mb-2">Need more tutorials and help?</h3>
                                <p className="text-gray-300 text-lg mb-6">Please leave your email, and I will get in touch with you as soon as possible.</p>
                                ...
                                <form ref={formRef} className="w-full lg:w-auto">
                                    ...
                                    {/* Success message */}
                                    {success && <p className="text-sm text-gray-400 mt-3">Thank you for your subscription!</p>}
                                    {!success && <p className="text-sm text-gray-400 mt-3">No spam and you can unsubscribe at any time</p>}
                                </form>
                            </div>

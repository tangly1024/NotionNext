      ...
      <div className='relative max-w-6xl mx-auto px-4 sm:px-6'>
        <div className='pt-12 md:pt-20'>
          ...
          <div className='max-w-3xl mx-auto text-center pb-12 md:pb-16'>
            <h1 className='h2 mb-4 dark:text-white'>
              {siteConfig('LANDING_FEATURES_HEADER_1', null, CONFIG)}
            </h1>
            <p
              className='text-xl text-gray-600 dark:text-gray-400 leading-relaxed'
              dangerouslySetInnerHTML={{
                __html: siteConfig('LANDING_FEATURES_HEADER_1_P', null, CONFIG)
              }}></p>
          </div>
              ...
              <div className='mb-8 md:mb-0'>
                <a
                  ...
                  <div>
                    <div className='font-bold leading-snug tracking-tight mb-1'>
                      {siteConfig(
                        'LANDING_FEATURES_CARD_1_TITLE',
                        null,
                        CONFIG
                      )}
                    </div>
                    <div className='text-gray-600'>
                      {siteConfig('LANDING_FEATURES_CARD_1_P', null, CONFIG)}
                    </div>
                  </div>
                ...
                <a
                  ...
                  <div>
                    <div className='font-bold leading-snug tracking-tight mb-1'>
                      {siteConfig(
                        'LANDING_FEATURES_CARD_2_TITLE',
                        null,
                        CONFIG
                      )}
                    </div>
                    <div className='text-gray-600'>
                      {siteConfig('LANDING_FEATURES_CARD_2_P', null, CONFIG)}
                    </div>
                  </div>
                  <div className='flex justify-center items-center w-8 h-8 bg-white rounded-full shadow flex-shrink-0 ml-3'>
                    <svg
                ...
                <a
                  ...
                  <div>
                    <div className='font-bold leading-snug tracking-tight mb-1'>
                      {siteConfig(
                        'LANDING_FEATURES_CARD_3_TITLE',
                        null,
                        CONFIG
                      )}
                    </div>
                    <div className='text-gray-600'>
                      {siteConfig('LANDING_FEATURES_CARD_3_P', null, CONFIG)}
                    </div>
                  </div>
                  <div className='flex justify-center items-center w-8 h-8 bg-white rounded-full shadow flex-shrink-0 ml-3'>
                    <svg

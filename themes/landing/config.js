const CONFIG = {
  ...
  LANDING_HERO_VIDEO_IFRAME:
    '//player.bilibili.com/player.html?aid=913088616&bvid=BV1fM4y1L7Qi&cid=1187218697&page=1&&high_quality=1',
  LANDING_HERO_VIDEO_TIPS: 'Watch the full video (2 min)',

  // 特性介绍
  LANDING_FEATURES_HEADER_1: '探索的过程',
  LANDING_FEATURES_HEADER_1_P:
    "如何搭建自己的门户网站，塑造一个品牌展示中心？<br/>曾经，它是系统<strong class='font-bold text-red-500'>繁重</strong>的Wordpress、是操作<strong class='font-bold  text-red-500'>复杂</strong>的Hexo、是<strong class='font-bold text-red-500'>昂贵</strong>且<strong class='font-bold text-red-500'>不稳定</strong>的技术团队;<br/>现在，只要一个Notion笔记就够了",
  LANDING_FEATURES_HEADER_2: 'Notion+NextJs组合方案',
  LANDING_FEATURES_HEADER_2_P:
    '在Notion笔记中管理文章数据，NextJs将其渲染成网页排版，通过Vercel等第三方平台将您的网站发布到全球。',
  LANDING_FEATURES_CARD_1_TITLE: '简单快速的系统',
  LANDING_FEATURES_CARD_1_P:
    '在Notion中写下一篇文章，内容立刻在您的网站首页中呈现给互联网',
  LANDING_FEATURES_CARD_2_TITLE: '高效传播的媒介',
  LANDING_FEATURES_CARD_2_P:
    '优秀的SEO、快速的响应速度，让您的产品和宣传触达到更多的受众',
  LANDING_FEATURES_CARD_3_TITLE: '人性化的定制工具',
  LANDING_FEATURES_CARD_3_P:
    '多款主题供您挑选，可以搭建各种不同风格和作用的网站，更多的主题正在陆续加入中。',

  // 特性介绍2
  LANDING_FEATURES_BLOCK_HEADER: '解决方案',
  LANDING_FEATURES_BLOCK_P:
    '人人自媒体的时代，一个网站将帮您链接更多的人，带给你无限的机会和客户。<br/>您还在等什么呢？',
  ...
  LANDING_POST_REDIRECT_ENABLE:
    process.env.NEXT_PUBLIC_POST_REDIRECT_ENABLE || false, // 是否开启文章地址重定向 ； 用于迁移旧网站域名
  LANDING_POST_REDIRECT_URL:
    process.env.NEXT_PUBLIC_POST_REDIRECT_URL || 'https://blog.tangly1024.com', // 重定向网站地址
  ...
  LANDING_PRICING_2_CONTENT:
    '项目源代码,部署教程,长期技术答疑,代码升级合并,内部社群',
  LANDING_PRICING_2_BUTTON: '立即购买',
  LANDING_PRICING_2_URL:
    'https://tangly1024.lemonsqueezy.com/checkout/buy/0adb9153-0799-4f51-91aa-1f06391ea4e0',

  LANDING_PRICING_3_TITLE: '企业版',
  LANDING_PRICING_3_PRICE: '$59/月',
  LANDING_PRICING_3_CONTENT:
    '项目源代码,部署教程,VIP技术咨询,代码升级合并,内部社群,定制功能开发,SEO优化',

    ...
    <div id='sideRight' className='hidden xl:block w-72 space-y-4 h-full'>
      ...
      <div className='sticky top-20 space-y-4'>
        ...
        {post && post.toc && post.toc.length > 0 && (
          <Card className='bg-white dark:bg-[#181e24] wow fadeInUp'>
        ...
        <div
          className={
            'border wow fadeInUp  hover:border-indigo-600  dark:hover:border-yellow-600 duration-200 dark:border-gray-700 dark:bg-[#181e24] dark:text-white rounded-xl lg:p-6 p-4 hidden lg:block bg-white'
          }>
        ...
        <Card
          className={
            'bg-white dark:bg-[#181e24] dark:text-white hover:border-indigo-600  dark:hover:border-yellow-600 duration-200'
          }>

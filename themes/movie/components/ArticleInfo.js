...
export const ArticleInfo = props => {
  ...
  return (
    <section className='w-full mx-auto mb-4'>
      <h2 className='text-4xl font-semibold py-10 dark:text-white text-center'>{post?.title}</h2>

      <div className='flex gap-3 font-semibold text-base items-center justify-center'>
        <Link

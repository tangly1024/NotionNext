        ...
        >
            ...
            <div className="lg:py-8 py-4 flex flex-col w-full">
                <Link
                    ...
                    passHref
                    className="cursor-pointer font-bold  hover:underline text-3xl leading-tight text-gray-700 dark:text-gray-300 hover:text-green-500 dark:hover:text-green-400"
                  >
                    <div>
                        {CONFIG.POST_LIST_COVER && <div className='w-full max-h-96 object-cover overflow-hidden mb-2 rounded-2xl'>
                            <LazyImage src={post?.pageCoverThumbnail || randomElement(CONFIG.DEFAULT_POST_IMAGE)} className='w-full max-h-96 object-cover hover:scale-125 duration-150' />
                        </div>}
                        {post.title}
                    </div>
                </Link>

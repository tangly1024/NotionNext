...
const Footer = ({ title }) => {
  ...
  return (
    ...
    >
      <span>
        <i className='fas fa-copyright' /> {`${copyrightDate}`} <span className='mx-1 animate-pulse'><i className='fas fa-heart' /></span> <a href='https://zhangqiyuan.xyz/article/wechat' className='underline font-bold '>{BLOG.AUTHOR}</a>
        &nbsp;&nbsp;&nbsp;

  ...
  return (
    ...
    >
      ...
      <span>
        ...
        <br />
        <h1>{title}</h1>
        <a href="https://ipw.cn/ipv6webcheck/?site=66619.eu.org" title="本站支持IPv6访问" target='_blank'><img style='display:inline-block;vertical-align:middle' alt="本站支持IPv6访问" src="https://static.ipw.cn/icon/ipv6-s1.svg"></a>

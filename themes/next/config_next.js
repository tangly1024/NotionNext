const CONFIG_NEXT = {
  ...
  HOME_BANNER: ture, // 首页是否显示大图及标语 [true,false]
  HOME_BANNER_Strings: ['追求得到之日即其终止之日，寻觅的过程亦即失去的过程。','反正年纪还小，日子还长，那就一边生活，一边期待吧。,让子弹飞一会儿！','时间的意义取决于人类：千年如一日，一日复千年。','每个人的心里，都有一个忘不记，却无法拥抱珍惜的人'], // 首页大图标语文字

...
const Footer = ({ siteInfo }) => {
  ...
  return (
    ...
    >
      ...
      <span className="hidden busuanzi_container_site_pv"> <i className="text-xs fas fa-eye" /><span className="px-1 busuanzi_value_site_pv"> </span>  </span>
      <span className="pl-2 hidden busuanzi_container_site_uv"> <i className="text-xs fas fa-users" /> <span className="px-1 busuanzi_value_site_uv"> </span> </span>

      ...
      <Dialog
        ...
        <Transition.Child
          ...
          <div
            ...
            className='fixed inset-0 z-10 glassmorphism transition-opacity'
          />
        </Transition.Child>
            ...
            <div className='pointer-events-none fixed inset-x-0 bottom-0 flex max-h-full pb-16'>
              <Transition.Child
                ...
                <Dialog.Panel
                  ...
                  className='pointer-events-auto relative y-screen max-h-md glassmorphism w-screen p-4 mb-2'>
                  <Transition.Child
                    as={Fragment}

const CONFIG = {
  ...
  MATERY_HOME_BANNER_GREETINGS: ['A geek in the Unmanned Aircraft System field', 'A leader with a dream', 'Interested in control theory & aircraft navigation and decision', 'Welcome to visit my blog🎉'], // 首页大图标语文字

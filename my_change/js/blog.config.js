...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，我是一个程序员, Hi，我是一个打工人,Hi，我是一个干饭人,Hi，我是一个摄影爱好者,欢迎来到我的博客🎉,任何能用JavaScript来做的事情，最终都会用JavaScript实现,',
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.vixcitycc.top/', // 网站地址
  ...
  CONTACT_YOUTUBE: process.env.NEXT_PUBLIC_CONTACT_YOUTUBE || 'https://space.bilibili.com/260909298', // Youtube主页

  NOTION_HOST: process.env.NEXT_PUBLIC_NOTION_HOST || 'https://www.notion.so', // Notion域名，您可以选择用自己的域名进行反向代理，如果不懂得什么是反向代理，请勿修改此项

  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || 'https://vixcity.gitee.io/my-gitee-blog/img/favicon.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  ...
  // 自定义外部脚本，外部样式
  CUSTOM_EXTERNAL_JS: ['https://pv.sohu.com/cityjson?ie=utf-8', 'https://cdn.jsdelivr.net/gh/Zfour/hexo-electric-clock@1.0.6/clock.js'], // e.g. ['http://xx.com/script.js','http://xx.com/script.js']
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'VIXCITY BLOG', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:

...
const BLOG = {
  ...
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || '223770929fc34c64887e850a77f7f453',
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，我是文雅的疯狂，欢迎来到我的个人博客🎉',
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '一枚AIGC学习爱好者，分享AI学习和使用心得，以及一些学习过程中使用到的实用小工具和资源，你的三连是我更新的最大动力~', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || '3489764419.top', // 网站地址
  ...
  CONTACT_BILIBILI: process.env.NEXT_PUBLIC_CONTACT_BILIBILI || 'https://b23.tv/dSzMtLR', // B站主页
  ...
  BACKGROUND_LIGHT: '#ee7cff', // use hex value, don't forget '#' e.g #fffefc
  BACKGROUND_DARK: '#000000', // use hex value, don't forget '#'
  SUB_PATH: '', // leave this empty unless you want to deploy in a folder

  POST_SHARE_BAR_ENABLE: process.env.NEXT_PUBLIC_POST_SHARE_BAR || 'true', // 文章分享功能 ，将在底部显示一个分享条
  POSTS_SHARE_SERVICES: process.env.NEXT_PUBLIC_POST_SHARE_SERVICES || 'wechat,qq,weibo,email,reddit', // 分享的服務，按顺序显示,逗号隔开
  ...
  ALGOLIA_APP_ID: process.env.NEXT_PUBLIC_ALGOLIA_APP_ID || null, // 在这里 https://dashboard.algolia.com/account/api-keys/查看 https://dashboard.algolia.com/account/api-keys/
  ...
  MUSIC_PLAYER_METING_ID:
        process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_ID || '5025382756', // 对应歌单的 id
  ...
  DESCRIPTION:
        process.env.NEXT_PUBLIC_DESCRIPTION || '欢迎', // 站点描述，被notion中的页面描述覆盖
  ...
  DEBUG: process.env.NEXT_PUBLIC_DEBUG || false, // 是否显示调试按钮ENABLE_CACHE: process.env.ENABLE_CACHE || process.env.npm_lifecycle_event === 'build', // 缓存在开发调试和打包过程中选择性开启，正式部署开启此功能意义不大。

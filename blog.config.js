...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID || '1ccb96a554568038a7ced81683d5ef85',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Lido', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '啥也没有', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'lido-room.vercel.app', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '琐碎,知识,记录', // 网站关键词 英文逗号隔开

...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi,I am a java developer,A filing system development,An ordinary, hard-living man,Welcome to my little world',

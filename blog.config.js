...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Flusskleid', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'NONSENSE', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://61.flusskleid.top', // 网站地址

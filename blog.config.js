...
const BLOG = {
  ...
  NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || 'c75695a59e004a49884ab705619254c6',
  ...
  AUTHOR: 'wyzhcn', // 作者
  BIO: '一个普通的干饭人🍚', // 作者简介
  LINK: 'https://wyzhcn.com', // 网站地址
  KEYWORDS: '博客, wyzhcn', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: 'me@wyzhcn.com', // 邮箱
  CONTACT_WEIBO: '', // 你的微博个人主页
  CONTACT_TWITTER: '', // 你的twitter个人主页
  CONTACT_GITHUB: 'https://github.com/wyzhcn', // 你的github个人主页
  ...
  ANALYTICS_GOOGLE_ID: process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'G-ZMCG5ZCDLW', // 谷歌Analytics的id e.g: G-XXXXXXXXXX

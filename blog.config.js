...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'RAD Studio', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '个人建筑师', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://radstudio.work', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '建筑设计,室内设计,设计工作室', // 网站关键词 英文逗号隔开
  ...
  // 谷歌广告
  ADSENSE_GOOGLE_ID: process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_ID || 'pub-8447089060490885', // 谷歌广告ID e.g ca-pub-xxxxxxxxxxxxxxxx
  ...
  ADSENSE_GOOGLE_SLOT_IN_ARTICLE:
    process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_SLOT_IN_ARTICLE || '3885103529', // Google AdScene>广告>按单元广告>新建文章内嵌广告 粘贴html代码中的data-ad-slot值
  ADSENSE_GOOGLE_SLOT_FLOW:
    process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_SLOT_FLOW || '1502482768', // Google AdScene>广告>按单元广告>新建信息流广告
  ...
  ADSENSE_GOOGLE_SLOT_AUTO:
    process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_SLOT_AUTO || '2153273351', // Google AdScene>广告>按单元广告>新建展示广告 （自动广告）

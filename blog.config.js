...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Energy', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.sbaaron.eu.org/', // 网站地址
  ...
  MUSIC_PLAYER_AUDIO_LIST: [
    // 示例音乐列表。除了以下配置外，还可配置歌词，具体配置项看此文档 https://aplayer.js.org/#/zh-Hans/
    {
      ...
      url: 'http://music.163.com/song/media/outer/url?id=2117905342.mp3',
      cover:
          'https://p1.music.126.net/kDKdNs8hv9aThGKNMtWx1g==/109951169282470776.jpg'
    },
    {
      name: '王都グランセル',
      artist: 'Falcom Sound Team jdk',

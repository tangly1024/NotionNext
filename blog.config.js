...
const BLOG = {
  API_BASE_URL: process.env.API_BASE_URL || 'https://xjxx.notion.so/api/v3', // API默认请求地址,可以配置成自己的地址例如：https://[xxxxx].notion.site/api/v3
  ...
  GREETING_WORDS:
    ...
    '凭何让彼此变一对雪人, 拥抱着等待决裂有声,凝固那还未幻灭的风景',
  ...
  CONTACT_BILIBILI: process.env.NEXT_PUBLIC_CONTACT_BILIBILI || 'https://space.bilibili.com/4192284', // B站主页

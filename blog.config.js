...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || 'To grow with us, and grow like golden buds', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.goldenbuds.online', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Goldenbuds，Led Grow Lights', // 网站关键词 英文逗号隔开

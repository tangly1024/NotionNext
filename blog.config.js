...
const BLOG = {
  ...
  COMMENT_TWIKOO_CDN_URL: process.env.NEXT_PUBLIC_COMMENT_TWIKOO_CDN_URL || 'https://cdn.staticfile.org/twikoo/1.6.29/twikoo.all.min.js', // twikoo客户端cdn //https://cdn.bootcdn.net/ajax/libs/twikoo/1.6.29/twikoo.all.min.js

...
const BLOG = {
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion.luoxue.site', // 网站地址
  ...
  PRISM_THEME_PREFIX_PATH: 'https://cdn.jsdelivr.net/npm/prismjs@1.29.0/themes/prism-okaidia.min.css', // 代码块默认主题

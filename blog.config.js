...
const BLOG = {
  ...
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Goldenbuds，LED Grow Lights, indoor farming lights，vertical planting LED bar lights', // 网站关键词 英文逗号隔开

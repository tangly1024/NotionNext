...
const BLOG = {
  ...
  NOTION_PAGE_ID:
  process.env.NOTION_PAGE_ID || 'cb9d51b3be09416ca251c3a3bce31c4c', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  ...
  CUSTOM_FONT_SANS: ['Noto Sans Simplified Chinese'], // 自定义无衬线字体
  CUSTOM_FONT_SERIF: ['Noto Sans Simplified Chinese'], // 自定义衬线字体
  ...
  CONTACT_EMAIL: 'support@keihan.co',
  CONTACT_WEIBO: '',
  CONTACT_TWITTER: 'https://twitter.com/catmangox',
  CONTACT_GITHUB: '',
  CONTACT_TELEGRAM: 'https://t.me/catmanapp',

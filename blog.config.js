...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '华仔', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '我在建造我的理想', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://xxxxxxxxxxxxxx', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Blog 华仔的小世界', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: Minghua.work@gmail.com || '', // 邮箱地址 例如mail@tangly1024.com

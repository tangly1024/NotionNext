...
const BLOG = {
  ...
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || '4a35a7af67f74a489a8aadbeafbd85b7',
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://matrix1024.cn', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '微信小程序开发', // 网站关键词 英文逗号隔开
  ...
  ANALYTICS_BAIDU_ID: process.env.NEXT_PUBLIC_ANALYTICS_BAIDU_ID || '6923125a23ab8395276a83b1e5bc50ea', // e.g 只需要填写百度统计的id，[baidu_id] -> https://hm.baidu.com/hm.js?[baidu_id]
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || '山生博客', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
        process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || '/bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
        process.env.NEXT_PUBLIC_DESCRIPTION || 'welcome', // 站点描述，被notion中的页面描述覆盖

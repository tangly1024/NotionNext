...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '㷫过㶧鎞', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '风平浪静，想起了你🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.gag.cc', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '基于Notion-Next搭建的博客', // 网站关键词 英文逗号隔开

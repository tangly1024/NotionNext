...
const BLOG = {
  ...
  LINK_WHITELIST: ['blog.stavmb.me'], // 外链跳转白名单，请根据需要进行修改，凡是链接中包含以下域名的，点击链接时不会进入中转页面
  ...
  // 自定义外部脚本，外部样式
  CUSTOM_EXTERNAL_JS: ['https://blog.stavmb.me'], // e.g. ['http://xx.com/script.js','http://xx.com/script.js']
  CUSTOM_EXTERNAL_CSS: ['https://blog.stavmb.me'], // e.g. ['http://xx.com/style.css','http://xx.com/style.css']

...
const BLOG = {
  ...
  SEO_GOOGLE_SITE_VERIFICATION:
    process.env.NEXT_PUBLIC_SEO_GOOGLE_SITE_VERIFICATION || '<script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-5015431604105277"
     crossorigin="anonymous"></script>', // Remove the value or replace it with your own google site verification code

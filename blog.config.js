...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Franz', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个乘客', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.znarf.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Franz, 空间', // 网站关键词 英文逗号隔开

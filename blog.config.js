...
const BLOG = {
  AUTHOR: '陈成龙', // 作者
  BIO: '穷则独善其身，达定兼济天下！', // 作者简介
  LINK: 'https://chenchenglong.com', // 网站地址
  KEYWORDS: '陈成龙, chenchenglong', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  ...
  CONTACT_EMAIL: 'ichenchenglong@gmail.com',
  CONTACT_WEIBO: '',
  CONTACT_TWITTER: '',
  CONTACT_GITHUB: '',
  CONTACT_TELEGRAM: '',
  ...
  ANALYTICS_BAIDU_ID: process.env.NEXT_PUBLIC_ANALYTICS_BAIDU_ID || '7b9bf7e7357692d3f7f4fad25bad2653', // e.g 只需要填写百度统计的id，[baidu_id] -> https://hm.baidu.com/hm.js?[baidu_id]

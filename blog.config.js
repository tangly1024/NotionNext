...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || "welcome to Henry's blog!", // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://crabass.me', // 网站地址
  KEYWORDS:
    process.env.NEXT_PUBLIC_KEYWORD ||
    'Blog, Website, Henry Johnson, tech, CrabAss', // 网站关键词 英文逗号隔开
  AVATAR:
    process.env.NEXT_PUBLIC_AVATAR ||
    'https://avatars.githubusercontent.com/u/13916997?s=40&v=4', // 站点头像
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/favicon.png', // blog favicon 配置，默认使用 /public/favicon.png
  ...
  // 自定义菜单
  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 默认使用Notion数据库里的Page生成导航；设为true时改用Menu/SubMenu

...
const BLOG = {
  ...
  AUTHOR: 'tobemaster', // 作者
  BIO: '前端工程师，高效沟通，简单生活，认真工作', // 作者简介
  ...
  COMMENT_GISCUS_REPO: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO || 'tobemaster56/NotionNext', // 你的Github仓库名 e.g 'tangly1024/NotionNext'

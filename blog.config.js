...
const BLOG = {
  API_BASE_URL: process.env.API_BASE_URL || 'https://walnut-tax-dd5.notion.site/api/v3', // API默认请求地址,可以配置成自己的地址例如：https://[xxxxx].notion.site/api/v3
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '文森Vincent', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '科技潮品、人工智能应用、iOS开发的业余爱好者', // 作者简介

...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'J的个人博客网站', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚，随便写些东西来玩玩。', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'www.123654321.tech', // 网站地址
  ...
  CONTACT_TELEGRAM: process.env.NEXT_PUBLIC_CONTACT_TELEGRAM || 'https://t.me/luckaaakk', // 你的telegram 地址 例如 https://t.me/tangly_1024

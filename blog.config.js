...
const BLOG = {
  ...
  LANG: process.env.NEXT_PUBLIC_LANG || 'zh-CN,en-US,zh-HK,zh-TW,fr-FR,tr-TR,ja-JP', // e.g 'zh-CN','en-US'  see /lib/lang.js for more.
  ...
  MUSIC_PLAYER_AUDIO_LIST: [
    // 示例音乐列表。除了以下配置外，还可配置歌词，具体配置项看此文档 https://aplayer.js.org/#/zh-Hans/
    {
      ...
      cover:
          'https://f4.bcbits.com/img/a0785612231_16.jpg'
    },
    {
      name: '王都グランセル',

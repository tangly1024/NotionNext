...
const BLOG = {
  ...
  LINK: 'https://blog.huguoyang.com', // 网站地址
  ...
  COMMENT_GISCUS_CATEGORY_ID: process.env.NEXT_PUBLIC_COMMENT_GISCUS_CATEGORY_ID || 'Announcements', // 你的Github Discussions 內的 Category ID ( 設定完 giscus 即可看到 )

...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '73e215be006e466e9c36442b39670776',
  ...
  GREETING_WORDS:
    ...
    'Hi，你要和我一起攀岩吗,Hi，我是一只吗喽,Hi，我是一个打工人,Hi，我是一个干饭人,欢迎来到我的博客🎉',
  ...
  // 根据文章 UUID 路径重定向到 slug 路径（依赖构建生成的 /public/redirect.json）
  UUID_REDIRECT: process.env.NEXT_PUBLIC_UUID_REDIRECT === 'true' || false,

...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '游戏爱好者', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://game.chawfoo.com', // 网站地址
  ...
  FONT_STYLE: process.env.NEXT_PUBLIC_FONT_STYLE || 'font-sans font-regular',

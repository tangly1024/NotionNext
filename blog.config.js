...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID || '0eaa0c53963e445ba7373226aa712633',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Javen73 BLOG', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '烟霞问讯，⾵月相知🌙', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.javen73.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Javen73, 博客, Java, Python, 机器学习, 深度学习, Nginx, 网络', // 网站关键词 英文逗号隔开
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '鲁ICP备18051174号', // 备案号 闽ICP备XXXXXXX
  ...
  COMMENT_GISCUS_REPO: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO || 'javen-73/NotionNext', // 你的Github仓库名 e.g 'tangly1024/NotionNext'
  COMMENT_GISCUS_REPO_ID: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO_ID || 'R_kgDOIbjgpw', // 你的Github Repo ID e.g ( 設定完 giscus 即可看到 )
  COMMENT_GISCUS_CATEGORY_ID:
    process.env.NEXT_PUBLIC_COMMENT_GISCUS_CATEGORY_ID || 'DIC_kwDOIbjgp84CXFK0', // 你的Github Discussions 內的 Category ID ( 設定完 giscus 即可看到 )
  ...
  COMMENT_CUSDIS_APP_ID: process.env.NEXT_PUBLIC_COMMENT_CUSDIS_APP_ID || '7b0728e1-401d-4628-b22b-f0d685412199', // data-app-id 36位 see https://cusdis.com/
  COMMENT_CUSDIS_HOST:
    process.env.NEXT_PUBLIC_COMMENT_CUSDIS_HOST || 'https://blog.javen73.com', // data-host, change this if you're using self-hosted version

...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '欢迎来到安寻心理🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '熊大', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '分享心理健康知识、技术、资源', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://heals.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '安寻心理', // 网站关键词 英文逗号隔开
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '京ICP备2021024556号-2', // 备案号 京ICP备xxx
  ...
  DESCRIPTION:
      process.env.NEXT_PUBLIC_DESCRIPTION || '安寻心理学分享平台', // 站点描述，被notion中的页面描述覆盖

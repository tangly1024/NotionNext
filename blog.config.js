...
const BLOG = {
  ...
  SINCE: process.env.NEXT_PUBLIC_SINCE || 0000, // e.g if leave this empty, current year will be used.
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '我找到了你', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '而你也找到了我。', // 作者简介

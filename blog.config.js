...
const BLOG = {
  ...
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || '9516674d1ac14d79bf17f2d3cff4337e',
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '茶话会现已开业，请您随意就坐，按需取餐🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'CFS', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '课题组分享论坛', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://cfsvariables.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion，博客，交流', // 网站关键词 英文逗号隔开

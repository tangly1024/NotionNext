...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'CZ', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '技术博主🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://juejin.cn/user/1086748304878360', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客,cc,cz,曹志,javascript,前端,promise,JS,js,ts', // 网站关键词 英文逗号隔开

...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'weny888', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://weny888.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'weny888, 博客,文远享当当,github,docker,n8n,分享,nas', // 网站关键词 英文逗号隔开

...
const BLOG = {
  ...
  NOTION_PAGE_ID:process.env.NOTION_PAGE_ID || 'b020703ef9d0431eaf1171e9f61a2b63',
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '我是一名程序员，我的理想是全世界的人都不需要学习外语就能无缝交流，我相信这是大势所趋趋势，我希望通过我的努力加速这一趋势。', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.belliedmonkey.cc', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'translation, transcription,programmer', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'belliedmonkey@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  ANALYTICS_GOOGLE_ID: process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'G-JC4DDCNE0K', // 谷歌Analytics的id e.g: G-XXXXXXXXXX
  ...
  // 微软 Clarity 站点分析
  CLARITY_ID: process.env.NEXT_PUBLIC_CLARITY_ID || 'm00i67a6k2', // 只需要复制Clarity脚本中的ID部分，ID是一个十位的英文数字组合
  ...
  // 谷歌广告
  ADSENSE_GOOGLE_ID: process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_ID || 'ca-pub-5236489512913533', // 谷歌广告ID e.g ca-pub-xxxxxxxxxxxxxxxx

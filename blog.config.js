// 注: process.env.XX是Vercel的环境变量，配置方式见：[https://docs.tangly1024.com/zh/features/personality](https://docs.tangly1024.com/zh/features/personality)
const BLOG = {
// Important page_id！！！Duplicate Template from  [https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5](https://www.notion.so/02ab3b8678004aa69e9e415905ef32a5)
NOTION_PAGE_ID:
...
THEME: process.env.NEXT_PUBLIC_THEME || 'medium', // 主题， 支持 ['next','hexo',"fukasawa','medium','example'] @see [https://preview.tangly1024.com](https://preview.tangly1024.com/)
THEME_SWITCH: process.env.NEXT_PUBLIC_THEME_SWITCH || true, // 是否显示切换主题按钮
LANG: process.env.NEXT_PUBLIC_LANG || 'zh-CN', // e.g 'zh-CN','en-US'  see /lib/lang.js for more.
SINCE: 2015, // e.g if leave this empty, current year will be used.
...
AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Haydonge', // 您的昵称 例如 tangly1024
BIO: process.env.NEXT_PUBLIC_BIO || '资深海外代孕专家', // 作者简介
LINK: process.env.NEXT_PUBLIC_LINK || '[https://knowivf.life](https://knowivf.life/)', // 网站地址
KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '海外代孕,格鲁吉亚代孕,哈萨克斯坦代孕,乌克兰代孕', // 网站关键词 英文逗号隔开

CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '', // 邮箱地址 例如mail@tangly1024.com
CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '[https://twitter.com/wklivf](https://twitter.com/wklivf)', // 你的twitter个人主页
CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || '', // 你的github个人主页 例如 [https://github.com/tangly1024](https://github.com/tangly1024)
CONTACT_TELEGRAM: process.env.NEXT_PUBLIC_CONTACT_TELEGRAM || '', // 你的telegram 地址 例如 [https://t.me/tangly_1024](https://t.me/tangly_1024)

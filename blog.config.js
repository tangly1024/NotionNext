...
const BLOG = {
  ...
  THEME: process.env。NEXT_PUBLIC_THEME || 'plog'， // 主题， 支持 ['next','hexo',"fukasawa','medium','example','matery','gitbook','simple'] @see https://preview.tangly1024.com
  ...
  GREETING_WORDS: process.env。NEXT_PUBLIC_GREETING_WORDS || 'Hi，我是一个创作者。欢迎来到我的博客🎉'，

  CUSTOM_MENU: process.env。NEXT_PUBLIC_CUSTOM_MENU || true， // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env。NEXT_PUBLIC_AUTHOR || '查卫风chawf'， // 您的昵称 例如 tangly1024
  BIO: process.env。NEXT_PUBLIC_BIO || '创作者'， // 作者简介
  LINK: process.env。NEXT_PUBLIC_LINK || 'https://www.chawfoo.com'， // 网站地址
  KEYWORDS: process.env。NEXT_PUBLIC_KEYWORD || 'AI,游戏'， // 网站关键词 英文逗号隔开

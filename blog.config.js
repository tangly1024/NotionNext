...
const BLOG = {
  ...
  GREETING_WORDS:
    process.env.NEXT_PUBLIC_GREETING_WORDS || 'Welcome to waytoAGI.com',
  ...
  POSTS_SHARE_SERVICES:
    ...
    'link,wechat,weibo,email,twitter', // 分享的服務，按顺序显示,逗号隔开
  ...
  ANALYTICS_GOOGLE_ID:
    process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'G-X2EXEE4LZW', // 谷歌Analytics的id e.g: G-XXXXXXXXXX
  ...
  // 谷歌广告
  ADSENSE_GOOGLE_ID:
    process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_ID || 'ca-pub-4820812869251361', // 谷歌广告ID e.g ca-pub-xxxxxxxxxxxxxxxx

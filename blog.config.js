...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '一个努力学习的区块链博主，欢迎关注', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://techzhao.ue.org', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '区块链, web3, blog', // 网站关键词 英文逗号隔开

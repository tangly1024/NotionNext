...
const BLOG = {
  ...
  NOTION_PAGE_ID:
      process.env.NOTION_PAGE_ID || '42aff7c539d244479c8cbec493c0420e',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '形声字', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '大音希声，大象无形', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://xingshengzi.cn', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '形声字', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'zoozle.zhou@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  CUSTOM_RIGHT_CLICK_CONTEXT_MENU: process.env.NEXT_PUBLIC_FONT_AWESOME_PATH || false, // 自定义右键菜单，覆盖系统菜单
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '备案号 京ICP备XXXXXXX', // 备案号 闽ICP备XXXXXXX

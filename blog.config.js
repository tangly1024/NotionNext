...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'louis16s', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个学种树的🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.louis16s.fun', // 网站地址
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个种树的, Hi，我是一个写代码的,Hi，我是一个干饭的,欢迎来到我的博客🎉',

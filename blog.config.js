...
const BLOG = {
  AUTHOR: '百川🌊', // 作者
  BIO: '做不被定义的海', // 作者简介
  LINK: 'https://www.baichuanweb.cn/', // 网站地址
  KEYWORDS: '思考，学习记录，随笔', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  process.env.NOTION_PAGE_ID || 'e06776e001ae456ebf09e7116b389ef0', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  ...
  CONTACT_EMAIL: '1318642891@qq.com',
  CONTACT_WEIBO: 'https://weibo.com/u/7526797796',
  CONTACT_TWITTER: '',
  CONTACT_GITHUB: 'https://github.com/Xuyan-cmd',
  CONTACT_TELEGRAM: '',
  ...
  WIDGET_PET_LINK:
    'https://cdn.jsdelivr.net/npm/live2d-widget-model-wanko@1.0.5/assets/nietzsche.model.json', // 挂件模型地址 @see https://github.com/xiazeyu/live2d-widget-models
  ...
  COMMENT_WALINE_SERVER_URL: process.env.NEXT_PUBLIC_WALINE_SERVER_URL || 'https://waline-ten-red.vercel.app/', // Waline 评论 @see https://waline.js.org/guide/get-started.html

...
const BLOG = {
  AUTHOR:'令狐afmaof',// 作者
  BIO:'一个专注于B端的产品狗',//作者简介
  LINK:'https://www.lhuafmaof.cn/', // 网站地址
  KEYWORDS:'B端,人工智能,CRM,客服,中后台', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  process.env.NOTION_PAGE_ID || 'cf56595225424c7f97e38420db4331f6', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  ...
  CONTACT_EMAIL: '609895092@qq.com',
  CONTACT_WEIBO: '',
  CONTACT_TWITTER: '',
  CONTACT_GITHUB: 'https://github.com/lhuafmaof',
  CONTACT_TELEGRAM: '',
  ...
  COMMENT_GISCUS_REPO: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO || 'lhuafmaof/NotionNext-newblog', // 你的Github仓库名 e.g 'tangly1024/NotionNext'
  ...
  ANALYTICS_BAIDU_ID: process.env.NEXT_PUBLIC_ANALYTICS_BAIDU_ID |032262cb547180851970d36f1d06f618| '', // e.g 只需要填写百度统计的id，[baidu_id] -> https://hm.baidu.com/hm.js?[baidu_id]

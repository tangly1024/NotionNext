...
const BLOG = {
  // Important page_id！！！Duplicate Template from https://yucliu.notion.site/6238c04e21b4431daefd8e1093ed0c79
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID || '6238c04e21b4431daefd8e1093ed0c79',
  ...
  CONTACT_TWITTER:
    process.env.NEXT_PUBLIC_CONTACT_TWITTER || 'https://twitter.com/xyuchengz', // 你的twitter个人主页
  // CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || '', // 你的github个人主页 例如 https://github.com/tangly1024
  // CONTACT_TELEGRAM: process.env.NEXT_PUBLIC_CONTACT_TELEGRAM || '', // 你的telegram 地址 例如 https://t.me/tangly_1024
  CONTACT_LINKEDIN:
    process.env.NEXT_PUBLIC_CONTACT_LINKEDIN ||
    'https://linkedin.com/in/liuyucheng', // 你的linkedIn 首页
  ...
  COMMENT_GISCUS_REPO:
    process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO || 'yucliu/NotionNext', // 你的Github仓库名 e.g 'tangly1024/NotionNext'
  COMMENT_GISCUS_REPO_ID:
    process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO_ID || 'yucliu/NotionNext', // 你的Github Repo ID e.g ( 設定完 giscus 即可看到 )
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || "Yucheng's BLOG", // 站点标题 ，被notion中的页面标题覆盖
  HOME_BANNER_IMAGE:
    process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || './bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION: process.env.NEXT_PUBLIC_DESCRIPTION || 'Yucheng L的个人站点', // 站点描述，被notion中的页面描述覆盖

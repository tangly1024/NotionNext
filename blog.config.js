...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '1286a25a7060804a80eaec65eb5f0451,en:1286a25a7060804a80eaec65eb5f0451',
  ...
  GREETING_WORDS:
    ...
    'I record to savor life a second time.',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Jinxia Wang', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'notion-next-bay-delta-15.vercel.app', // 网站地址
  ...
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/my-favicon.ico-circle.png', // blog favicon 配置, 默认使用 /public/favicon.ico，写作'/favicon.ico'，支持在线图片，如 https://img.imesong.com/favicon.png
  ...
  // 文章URL前缀
  POST_URL_PREFIX: process.env.NEXT_PUBLIC_POST_URL_PREFIX ?? 'wjx',
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'Jinxia Wang', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:

...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'ねぇ最高な时间を旅しませんか,もし夢を見るならば、大きく見なさい,あなたと一緒に楽しい星に逃げたいです',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'fufu酱', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'ZJU’26 | CS | ITP | xlab | 开源自我 | 数字游民 | Fintech | DS', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-six-rouge.vercel.app/', // 网站地址
  ...
  PRISM_THEME_PREFIX_PATH: process.env.NEXT_PUBLIC_PRISM_THEME_PREFIX_PATH || 'https://cdn.jsdelivr.net/npm/prismjs@1.29.0/themes/prism-shades-of-purple.css', // 代码块默认主题
  ...
  PRISM_THEME_DARK_PATH: process.env.NEXT_PUBLIC_PRISM_THEME_DARK_PATH || 'https://cdn.jsdelivr.net/npm/prismjs@1.29.0/themes/prism-shades-of-purple.min.css', // 深色模式主题
  ...
  CHATBASE_ID: process.env.NEXT_PUBLIC_CHATBASE_ID || gBPAkeQg7z4Ysu2NmwVlQ,
  ...
  WEB_WHIZ_CHAT_BOT_ID: process.env.NEXT_PUBLIC_WEB_WHIZ_CHAT_BOT_ID || gBPAkeQg7z4Ysu2NmwVlQ, // 在后台获取ID

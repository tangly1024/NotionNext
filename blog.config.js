...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '给忙碌的现代人对聪明工作，快乐生活的指南',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '柒磊', // 您的昵称 例如 tangly1024
  ...
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '搞钱,副业,创业,变现,生活,远程工作,自由职业,AIGC', // 网站关键词 英文逗号隔开

...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Tonser', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '闲人，散人，醉人', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.tonser.top', // 网站地址

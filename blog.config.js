...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Laurence Ng', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'You Only Live Once✨', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://laurenceng.vercel.app', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, blog', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'Laurence0202ng@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || 'https://twitter.com/LaurenceNg_', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/Laurence0202Ng', // 你的github个人主页 例如 https://github.com/tangly1024
  CONTACT_TELEGRAM: process.env.NEXT_PUBLIC_CONTACT_TELEGRAM || '', // 你的telegram 地址 例如 https://t.me/tangly_1024
  CONTACT_LINKEDIN: process.env.NEXT_PUBLIC_CONTACT_LINKEDIN || 'https://linkedin.com/in/wu-mengyao', // 你的linkedIn 首页
  CONTACT_INSTAGRAM: process.env.NEXT_PUBLIC_CONTACT_INSTAGRAM || 'https://instagram.com/l.aurence_ng', // 您的instagram地址
  ...
  BACKGROUND_LIGHT: '#A6C2CE', // use hex value, don't forget '#' e.g #fffefc
  BACKGROUND_DARK: '#232941', // use hex value, don't forget '#'
  SUB_PATH: '', // leave this empty unless you want to deploy in a folder

  POST_SHARE_BAR_ENABLE: process.env.NEXT_PUBLIC_POST_SHARE_BAR || 'true', // 文章分享功能 ，将在底部显示一个分享条
  POSTS_SHARE_SERVICES: process.env.NEXT_PUBLIC_POST_SHARE_SERVICES || 'link,wechat,qq,weibo,email,facebook,twitter,telegram,messenger,line,reddit,whatsapp,linkedin,tumblr', // 分享的服務，按顺序显示,逗号隔开
  ...
  MUSIC_PLAYER_AUDIO_LIST: [
    // 示例音乐列表。除了以下配置外，还可配置歌词，具体配置项看此文档 https://aplayer.js.org/#/zh-Hans/
    {
      name: 'Valder Fields',
      artist: 'Tamas Wells',
      url: 'https://soundcloud.com/edmund-fong/valder-fields-tamas-wells-mp3',
      cover:
          'https://f4.bcbits.com/img/a0785612231_10.jpg'
    },
    {
      name: '王都グランセル',
  ...
  COMMENT_GITALK_ADMIN: process.env.NEXT_PUBLIC_COMMENT_GITALK_ADMIN || 'Laurence Ng', // 管理员用户名、一般是自己 e.g 'tangly1024'
  ...
  COMMENT_VALINE_PLACEHOLDER:
      process.env.NEXT_PUBLIC_VALINE_PLACEHOLDER || '留下你的脚印吧👣', // 可以搭配后台管理评论 https://github.com/DesertsP/Valine-Admin  便于查看评论，以及邮件通知，垃圾评论过滤等功能
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'Laurence Ng, // 站点标题 ，被notion中的页面标题覆盖
  HOME_BANNER_IMAGE:

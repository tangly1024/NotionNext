...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Kingsley', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '半导体器件工程师', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://garlan.top', // 网站地址

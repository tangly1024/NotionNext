...
const BLOG = {
  ...
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '产品经理,金融工程,数据分析', // 网站关键词 英文逗号隔开
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '浙ICP备2024106896号', // 备案号 闽ICP备XXXXXXX
  ...
  MUSIC_PLAYER_AUDIO_LIST: [
    // 示例音乐列表。除了以下配置外，还可配置歌词，具体配置项看此文档 https://aplayer.js.org/#/zh-Hans/
    {
      ...
      cover:
        'p2.music.126.net/e-yrBMNr2s79bqkyTPY9aw==/109951169255671025.jpg?param=90y90'
    }
  ],
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || '江雪独钓翁', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:

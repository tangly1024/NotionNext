...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '宝库商店', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://baoku.shop', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '软件, 破解，游戏，VPN，翻墙，梯子，破解软件，影视软件，机场', // 网站关键词 英文逗号隔开

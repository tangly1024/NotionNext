...
const BLOG = {
  ...
  APPEARANCE: process.env.NEXT_PUBLIC_APPEARANCE || 'auto', // ['light', 'dark', 'auto'], // light 日间模式 ， dark夜间模式， auto根据时间和主题自动夜间模式
    ...
    GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '西风吹老洞庭波，一夜湘君白发多。醉后不知天在水，满船清梦压星河。🎉',
  
    CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。
  
    AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '100岁的好奇宝宝', // 您的昵称 例如 tangly1024
    BIO: process.env.NEXT_PUBLIC_BIO || '世界真好玩, 每天都有新玩具', // 作者简介
    LINK: process.env.NEXT_PUBLIC_LINK || 'https://88.uy', // 网站地址
    KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '博客, 图像, CIS, VPS', // 网站关键词 英文逗号隔开
    // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
    CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'admin@88.uy', // 邮箱地址 例如mail@tangly1024.com
  ...
  WIDGET_PET_SWITCH_THEME: false, // 点击宠物挂件切换博客主题
    ...
    TITLE: process.env.NEXT_PUBLIC_TITLE || '100岁的好奇宝宝', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
    HOME_BANNER_IMAGE:

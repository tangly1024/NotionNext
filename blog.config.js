...
const BLOG = {
  AUTHOR: 'ryu', // 作者
  BIO: '( •̀ ω •́ )✧', // 作者简介
  LINK: 'https://notion-next-sigma-seven.vercel.app/', // 网站地址
  KEYWORDS: 'Notion, 博客', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  process.env.NOTION_PAGE_ID || '357f5597d0844c3cb8534f6eb6957fe4', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  ...
  WIDGET_PET_LINK:
    'https://cdn.jsdelivr.net/npm/live2d-widget-model-wanko@1.0.5/assets/tororo.model.json', // 挂件模型地址 @see https://github.com/xiazeyu/live2d-widget-models

// 注: process.env.XX是Vercel的环境变量，配置方式见：https://docs.tangly1024.com/article/how-to-config-notion-next#c4768010ae7d44609b744e79e2f9959a n. 
const BLOG = {
  ...
  GREETING_WORDS:
    process.env.NEXT_PUBLIC_GREETING_WORDS ||'欢迎来到变态小说网',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || true, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '连妹妹都上的变态哥哥', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '变态集团董事长', // 作者简介
  ...
  CONTACT_TELEGRAM: process.env.NEXT_PUBLIC_CONTACT_TELEGRAM || 'https://t.me/Abnormal_Group', // 你的telegram 地址 例如 https://t.me/tangly_1024
  ...
  WIDGET_PET_LINK:
    ...
    'https://raw.githubusercontent.com/imuncle/live2d/master/model/dollsfrontline/dsr50_2101/destroy/model.json', // 挂件模型地址 @see https://github.com/xiazeyu/live2d-widget-models

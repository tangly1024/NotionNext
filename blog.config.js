...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '1465019e835180708d88df32abddabf7',
  ...
  GREETING_WORDS:
    ...
    '捕捉美好时刻 | 记录思考感悟 | 分享效率工具 | 探索人工智能',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '大鹏', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '资深产品人|专业铲屎官|业余摄影师|AI 研究员', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://hidapeng.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '大鹏笔记,产品人,铲屎官,摄影师,AI研究员', // 网站关键词 英文逗号隔开

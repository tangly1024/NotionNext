...
const BLOG = {
  ...
  DEBUG: process.env.NEXT_PUBLIC_DEBUG || true, // 是否显示调试按钮ENABLE_CACHE: process.env.ENABLE_CACHE || process.env.npm_lifecycle_event === 'build', // 缓存在开发调试和打包过程中选择性开启，正式部署开启此功能意义不大。

...
const BLOG = {
  ...
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || 'https://github.com/tangly1024/NotionNext/assets/120654757/0d30205d-c540-420e-9665-a5f2955675f8', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  ...
  FACEBOOK_PAGE_TITLE: process.env.NEXT_PUBLIC_FACEBOOK_PAGE_TITLE || FACEBOOK 粉丝团, // 邊欄 Facebook Page widget 的標題欄，填''則無標題欄 e.g FACEBOOK 粉絲團'
  FACEBOOK_PAGE: process.env.NEXT_PUBLIC_FACEBOOK_PAGE || https://www.facebook.com/tw.andys.pro, // Facebook Page 的連結 e.g https://www.facebook.com/tw.andys.pro
  ...
  WIDGET_PET_LINK:
        ...
        'model/dollsfrontline/shield/model2.json', // 挂件模型地址 @see https://github.com/xiazeyu/live2d-widget-models

...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '飞鸟集', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '——心爱的，,再会了。', // 作者简介
  ...
  WIDGET_PET_LINK:
        ...
        'https://cdn.jsdelivr.net/npm/live2d-widget-model-nietzsche@1.0.5/assets/nietzsche.model.json', // 挂件模型地址 @see https://github.com/xiazeyu/live2d-widget-models

...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，我是一个程序员, Hi，我是一个cluer,Hi，我是一个足球粉,欢迎来到我的博客🎉',
  ...
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'wichai_pan@oulook.com', // 邮箱地址 例如mail@tangly1024.com

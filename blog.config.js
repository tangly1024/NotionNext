...
const BLOG = {
  ...
  COMMENT_GITALK_JS_CDN_URL:
    ...
    'https://unpkg.com/gitalk@1/dist/gitalk.min.js', // gitalk客户端 js cdn
  COMMENT_GITALK_CSS_CDN_URL:
    process.env.NEXT_PUBLIC_COMMENT_GITALK_CSS_CDN_URL ||
    'https://unpkg.com/gitalk@1/dist/gitalk.css', // gitalk客户端 css cdn
  ...
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '做学问可不是赶潮流、没有冷门热门之说。', // 站点描述，被notion中的页面描述覆盖

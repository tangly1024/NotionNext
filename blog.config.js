...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '小林', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的程序员🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'xiaolin.icu', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '1907334859@qq.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  MUSIC_PLAYER_AUDIO_LIST: [
    // 示例音乐列表。除了以下配置外，还可配置歌词，具体配置项看此文档 https://aplayer.js.org/#/zh-Hans/
    {
      name: '起风了',
      artist: '买辣条也用券',
      url: 'https://music.163.com/song/media/outer/url?id=1953454767.mp3',
      cover:
         'https://img0.baidu.com/it/u=1147088384,1362120479&fm=253&fmt=auto&app=138&f=JPEG?w=500&h=500'
    },
    {
      name: '从你的全世界路过',
      artist: ' ',
      url: 'https://music.163.com/song/media/outer/url?id=436667409.mp3',
      cover:
          'https://img0.baidu.com/it/u=1147088384,1362120479&fm=253&fmt=auto&app=138&f=JPEG?w=500&h=500'
    },
    {
      name: '圣诞快乐劳伦斯先生',
      artist: '坂本龙一',
      url: 'https://music.163.com/song/media/outer/url?id=1908127754.mp3',
      cover:
          'https://img0.baidu.com/it/u=1147088384,1362120479&fm=253&fmt=auto&app=138&f=JPEG?w=500&h=500'
    },
    {
    ...
    //   name: '忘不掉的你',
    //   artist: '江辰',
    //   url: 'https://music.163.com/song/media/outer/url?id=1851652156.mp3',
    //   cover:
    //       'https://img0.baidu.com/it/u=1147088384,1362120479&fm=253&fmt=auto&app=138&f=JPEG?w=500&h=500'
    // },
    {
      name: '无感',
      artist: '江辰',
      url: 'https://music.163.com/song/media/outer/url?id=1951426761.mp3',
      cover:
          'https://img0.baidu.com/it/u=1147088384,1362120479&fm=253&fmt=auto&app=138&f=JPEG?w=500&h=500'
    }
  ],
  ...
  MUSIC_PLAYER_METING_ID:
      process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_ID || '3461121706', // 对应歌单的 id

...
const BLOG = {
  ...
  APPEARANCE: process.env.NEXT_PUBLIC_APPEARANCE || 'true', // ['light', 'dark', 'auto'], // light 日间模式 ， dark夜间模式， auto根据时间和主题自动夜间模式
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'VC音乐', // 您的昵称 例如 tangly1024
  ...
  CONTACT_INSTAGRAM: process.env.NEXT_PUBLIC_CONTACT_INSTAGRAM || 'https://www.instagram.com/m24_spokesperson_vc/', // 您的instagram地址
  ...
  WIDGET_PET_LINK:
    ...
    'https://raw.githubusercontent.com/imuncle/live2d/master/model/Pio/model1.json', // 挂件模型地址 @see https://github.com/xiazeyu/live2d-widget-models

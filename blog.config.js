...
const BLOG = {
  ...
  COMMENT_TWIKOO_CDN_URL: process.env.NEXT_PUBLIC_COMMENT_TWIKOO_CDN_URL || 'https://registry.npmmirror.com/twikoo/1.6.38/files/dist/twikoo.all.min.js', // twikoo客户端cdn

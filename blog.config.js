...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，我是 FMoran，欢迎来到我的博客🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'FMoran', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '👀 Everything should be blurry ', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://fmoran.me', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Blog, FMoran, MoranFong, 白丁轶事, Notion, 博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'i@fmoran.me', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || 'https://twitter.com/NoPeople404', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/flysheepfdn', // 你的github个人主页 例如 https://github.com/tangly1024
  CONTACT_TELEGRAM: process.env.NEXT_PUBLIC_CONTACT_TELEGRAM || '', // 你的telegram 地址 例如 https://t.me/tangly_1024
  CONTACT_LINKEDIN: process.env.NEXT_PUBLIC_CONTACT_LINKEDIN || '', // 你的linkedIn 首页
  CONTACT_INSTAGRAM: process.env.NEXT_PUBLIC_CONTACT_INSTAGRAM || 'https://www.instagram.com/fmoran.me/', // 您的instagram地址
  ...
  COMMENT_UTTERRANCES_REPO:
        process.env.NEXT_PUBLIC_COMMENT_UTTERRANCES_REPO || 'flysheepfdn/FMoran-Blog', // 你的代码仓库名， 例如我是 'tangly1024/NotionNext'； 更多文档参考 https://utteranc.es/

  // giscus @see https://giscus.app/
  COMMENT_GISCUS_REPO: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO || 'https://github.com/flysheepfdn/FMoran-Blog', // 你的Github仓库名 e.g 'tangly1024/NotionNext'
  ...
  // <---- 站点统计
curl --request POST  //自行添加 Cloudflare 跟踪 
    --url https://api.cloudflare.com/client/v4/accounts/f5cfedc65b69296c993a35a7237b786e/request-tracer/tracer     --header 'Content-Type: application/json'  
    --header 'Authorization: Bearer $CF_AUTH_TOKEN'  
    --data '{"url":"https://fmoran.me","method":"GET","context":{"geoloc":{"iso_code":"CN"}}}'

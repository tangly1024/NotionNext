...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '2aa107292510819f9a99cc8aee54b999,en:7c1d570661754c8fbc568e00a01fd70e', //02ab3b8678004aa69e9e415905ef32a5
  THEME: process.env.NEXT_PUBLIC_THEME || 'aurora', // 当前主题，在themes文件夹下可找到所有支持的主题；主题名称就是文件夹名，例如 example,fukasawa,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'VinkoYang', // 您的昵称 例如 tangly1024

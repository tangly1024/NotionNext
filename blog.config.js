...
const BLOG = {
  ...
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || '9231b98a817e45d5a5f1ba394a7b4cf2',
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，我是一个互联网冲浪人，对各种有趣的事感兴趣，喜欢技术，喜欢中医，喜欢音乐，欢迎来到我的博客🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '王晓龙 Home', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '技术改变生活', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://gok8s.net', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, IT技术, 中医学问', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'xiaolongw123@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || 'https://twitter.com/xiaolongw123', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/wxlbj', // 你的github个人主页 例如 https://github.com/tangly1024
  CONTACT_TELEGRAM: process.env.NEXT_PUBLIC_CONTACT_TELEGRAM || 'https://t.me/wxlhome', // 你的telegram 地址 例如 https://t.me/tangly_1024
  ...
  MUSIC_PLAYER_AUDIO_LIST: [
    // 示例音乐列表。除了以下配置外，还可配置歌词，具体配置项看此文档 https://aplayer.js.org/#/zh-Hans/
    {
      name: '被遺忘的時光',
      artist: '蔡琴',
      url: 'https://re.ivykid.com/timeofmemory.mp3',
      cover:
            'https://re.ivykid.com/time.jpg'
    },
    {
      name: '稻香',
      artist: '周杰伦',
      url: 'https://re.ivykid.com/%E7%A8%BB%E9%A6%99.mp3',
      cover:
            'https://re.ivykid.com/%E7%A8%BB%E9%A6%99.jpeg'
    }
  ],

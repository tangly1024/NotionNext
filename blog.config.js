...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个产品经理, Hi，我是一个打工人,Hi，我是一个干饭人,欢迎来到我的博客🎉',
  ...
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '产品经理,需求分析,金融工程,Python,数据挖掘,数据分析,数据分析师,大数据分析师,金融业务,固定收益,高等数学,统计学,线性代数,软件编程,工具', // 网站关键词 英文逗号隔开
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '浙ICP备2024106896号-1', // 备案号 闽ICP备XXXXXXX
  ...
  MUSIC_PLAYER_AUDIO_LIST: [
    // 示例音乐列表。除了以下配置外，还可配置歌词，具体配置项看此文档 https://aplayer.js.org/#/zh-Hans/
    {
      ...
      url: 'https://music.163.com/outchain/player?type=2&id=2151896978&auto=1&height=66',
      cover:
        ''
    }
  ],
  ...
  MUSIC_PLAYER_METING_SERVER:
    process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_SERVER || 'baidu', // 音乐平台，[netease, tencent, kugou, xiami, baidu]
  ...
  ANALYTICS_BAIDU_ID: process.env.NEXT_PUBLIC_ANALYTICS_BAIDU_ID || '0e8d43ed2be5f70ac01cafb06dfc4565', // e.g 只需要填写百度统计的id，[baidu_id] -> https://hm.baidu.com/hm.js?[baidu_id]
  ...
  SEO_BAIDU_SITE_VERIFICATION:
    process.env.NEXT_PUBLIC_SEO_BAIDU_SITE_VERIFICATION || 'codeva-M2WBKkobix', // Remove the value or replace it with your own google site verification code
  ...
  // 谷歌广告
  ADSENSE_GOOGLE_ID: process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_ID || 'pub-7913495439904743', // 谷歌广告ID e.g ca-pub-xxxxxxxxxxxxxxxx
  ...
  ADSENSE_GOOGLE_SLOT_IN_ARTICLE:
    process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_SLOT_IN_ARTICLE || '3423102938', // Google AdScene>广告>按单元广告>新建文章内嵌广告 粘贴html代码中的data-ad-slot值
  ADSENSE_GOOGLE_SLOT_FLOW:
    process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_SLOT_FLOW || '6507257818', // Google AdScene>广告>按单元广告>新建信息流广告
  ADSENSE_GOOGLE_SLOT_NATIVE:
    process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_SLOT_NATIVE || '4544612912', // Google AdScene>广告>按单元广告>新建原生广告
  ADSENSE_GOOGLE_SLOT_AUTO:
    process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_SLOT_AUTO || '1918449570', // Google AdScene>广告>按单元广告>新建展示广告 （自动广告）
  ADSENSE_GOOGLE_SLOT_AUTO:
    process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_SLOT_AUTO || '7909142858', // Google AdScene>广告>按单元广告>新建展示广告 （自动广告）
  ADSENSE_GOOGLE_SLOT_AUTO:
    process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_SLOT_AUTO || '4619461071', // Google AdScene>广告>按单元广告>新建展示广告 （自动广告）

...
const BLOG = {
  ...
  NOTION_PAGE_ID:
      process.env.NOTION_PAGE_ID || '3da5fb36ef65429eb5fed30e3feacf44',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '我养了一只小青蛙', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '欢迎来到我的博客,一个普通的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://xiaojian.vip', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '博客', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'qijian1790@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  // CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  // CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/xiaojian186/NotionNext', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  MUSIC_PLAYER_AUDIO_LIST: [
    ...
    {
      name: 'Where Did U Go',
      artist: 'Where Did U Go',
      url: 'https://music.163.com/song?id=234064&userid=1570385385',
      cover:
          'https://pic.rmb.bdstatic.com/bjh/686dd453b90d23c339dc087f9181c84a.jpeg'
    }
  ],
  ...
  // twikoo
  COMMENT_TWIKOO_ENV_ID: process.env.NEXT_PUBLIC_COMMENT_ENV_ID || 'https://twikoo-test-drab.vercel.app/', // TWIKOO后端地址 腾讯云环境填envId；Vercel环境填域名，教程：https://tangly1024.com/article/notionnext-twikoo
  ...
  //     process.env.NEXT_PUBLIC_COMMENT_UTTERRANCES_REPO || 'xiaojian186/NotionNext', // 你的代码仓库名， 例如我是 'tangly1024/NotionNext'； 更多文档参考 https://utteranc.es/

  // giscus @see https://giscus.app/
  // COMMENT_GISCUS_REPO: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO || 'xiaojian186/NotionNext', // 你的Github仓库名 e.g 'tangly1024/NotionNext'
  ...
  // COMMENT_GITALK_OWNER: process.env.NEXT_PUBLIC_COMMENT_GITALK_OWNER || 'xiaojian186', // 你的用户名 e.g tangly1024
  // COMMENT_GITALK_ADMIN: process.env.NEXT_PUBLIC_COMMENT_GITALK_ADMIN || 'xiaojian186', // 管理员用户名、一般是自己 e.g 'tangly1024'
  ...
  ADSENSE_GOOGLE_SLOT_FLOW: process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_SLOT_FLOW || '', // 1510444138Google AdScene>广告>按单元广告>新建信息流广告
  ADSENSE_GOOGLE_SLOT_NATIVE: process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_SLOT_NATIVE || '', //4980048999 Google AdScene>广告>按单元广告>新建原生广告
  ADSENSE_GOOGLE_SLOT_AUTO: process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_SLOT_AUTO || '', // G8807314373oogle AdScene>广告>按单元广告>新建展示广告 （自动广告）

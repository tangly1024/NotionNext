...
const BLOG = { 
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Vama', // 昵称
  BIO: process.env.NEXT_PUBLIC_BIO || 'Code • Math • Trade', // 简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.vama.uk', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Vama, Blog', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'me@vama.uk', // 邮箱地址
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/VamRed', // 你的github个人主页 
  CONTACT_TELEGRAM: process.env.NEXT_PUBLIC_CONTACT_TELEGRAM || 'https://t.me/vama_uk', // 你的telegram 地址 
  CONTACT_LINKEDIN: process.env.NEXT_PUBLIC_CONTACT_LINKEDIN || '', // 你的linkedIn 首页
  CONTACT_INSTAGRAM: process.env.NEXT_PUBLIC_CONTACT_INSTAGRAM || '', // 您的instagram地址
  CONTACT_BILIBILI: process.env.NEXT_PUBLIC_CONTACT_BILIBILI || 'https://space.bilibili.com/225706407?spm_id_from=333.1007.0.0', // B站主页
  CONTACT_YOUTUBE: process.env.NEXT_PUBLIC_CONTACT_YOUTUBE || 'https://www.youtube.com/channel/UCyGX0HADQpRosnCYFvx_pew', // Youtube主页

  NOTION_HOST: process.env.NEXT_PUBLIC_NOTION_HOST || 'https://www.notion.so', // Notion域名，您可以选择用自己的域名进行反向代理，如果不懂得什么是反向代理，请勿修改此项

  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || 'https://cdn.discordapp.com/attachments/1192170994379526208/1192424413841334302/favicon.ico?ex=65a906c6&is=659691c6&hm=1116e29564930db483634bfccdb189c5df4659aec71a34a02be671616b25e171&', // blog favicon 配置, 默认使用 /public/favicon.ico
  ...
  // 自定义外部脚本，外部样式
  CUSTOM_EXTERNAL_JS: ['https://cdn.jsdelivr.net/gh/VamRed/ai_zzy@2.1/cdn/yinghua.js','https://cdn.jsdelivr.net/gh/VamRed/ai_zzy@2/cdn/disabled.js'], // e.g. ['http://xx.com/script.js','http://xx.com/script.js']
  ...
  FACEBOOK_PAGE_ID: process.env.NEXT_PUBLIC_FACEBOOK_PAGE_ID || null, // Facebook Page ID 來啟用 messenger 聊天功能
  FACEBOOK_APP_ID: process.env.NEXT_PUBLIC_FACEBOOK_APP_ID || null, // Facebook App ID 來啟用 messenger 聊天功能 获取: https://developers.facebook.com/

  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '浙ICP备20021002号', // 备案号
  ...
  BACKGROUND_LIGHT: '#000000', // use hex value, don't forget '#' e.g #fffefc
  ...
  // 作废配置
  AVATAR: process.env.NEXT_PUBLIC_AVATAR || 'https://github.com/VamRed/ai_zzy/assets/120654757/6be1c132-cfac-4902-8497-a28508550339', // 作者头像，被notion中的ICON覆盖。若无ICON则取public目录下的avatar.png
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'Vama Blog', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
        process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || '/bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
        process.env.NEXT_PUBLIC_DESCRIPTION || '这是Vama的个人博客网站', // 站点描述，被notion中的页面描述覆盖

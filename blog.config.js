...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Hurtblack', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '内河大魔王', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://ltyzqhh.top', // 网站地址

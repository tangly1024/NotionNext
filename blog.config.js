...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Scorpion', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.d66.cn', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'd66,网络奇趣站,最新网络科技,实用网络工具,网络娱乐推荐,网络技术趋势,好用软件推荐,数字文化分享,数字时代资讯', // 网站关键词 英文逗号隔开
  ...
  ALGOLIA_APP_ID: process.env.NEXT_PUBLIC_ALGOLIA_APP_ID || 'JW6VR9A6AY', // 在这里查看 https://dashboard.algolia.com/account/api-keys/
  ALGOLIA_ADMIN_APP_KEY: process.env.ALGOLIA_ADMIN_APP_KEY || '4cf1bbbe182105408c99b854dc2bc632', // 管理后台的KEY，不要暴露在代码中，在这里查看 https://dashboard.algolia.com/account/api-keys/
  ALGOLIA_SEARCH_ONLY_APP_KEY: process.env.NEXT_PUBLIC_ALGOLIA_SEARCH_ONLY_APP_KEY || '61d318b43d15222f5af9605b43627fe3', // 客户端搜索用的KEY
  ALGOLIA_INDEX: process.env.NEXT_PUBLIC_ALGOLIA_INDEX || 'd66', // 在Algolia中创建一个index用作数据库
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'D66分享网', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
        process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || '/bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
        process.env.NEXT_PUBLIC_DESCRIPTION || '欢迎来到D66分享站，你的网络奇趣之旅！在这里，我们精选分享各类趣站、网络技术、好用软件等精彩资源，助你畅游互联网的海洋。发现新奇，了解技术，体验便捷，D66.cn陪你一起探索无尽的网络世界。立即加入我们，掌握最新潮的网络资讯，畅享数字时代的精彩旅程！', // 站点描述，被notion中的页面描述覆盖

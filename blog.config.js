...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID || '18907c140b9f4154a8d41271c2efe65d',
  ...
  CONTACT_EMAIL: 'gshkuang@gmail.com', // 邮箱
  CONTACT_WEIBO: '', // 你的微博个人主页
  CONTACT_TWITTER: '', // 你的twitter个人主页
  CONTACT_GITHUB: 'https://github.com/gshkuang', // 你的github个人主页
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || '浮世随想集', // 站点标题 ，被notion中的页面标题覆盖
  HOME_BANNER_IMAGE: './bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION: process.env.NEXT_PUBLIC_DESCRIPTION || '一个人站点', // 站点描述，被notion中的页面描述覆盖

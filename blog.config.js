...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '3a6028e7399b4acd852bce3c1e0e6c3b',
  ...
  GREETING_WORDS:
    ...
    '阅尽千帆终执手，此心安处是吾乡,天地不仁，以萬物為芻狗。,聖人不仁，以百姓為芻狗。,先行其言而后从之。',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || true, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'ZT', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '先行其言而后从之', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://musingpages.com', // 网站地址
  ...
  POST_URL_PREFIX: process.env.NEXT_PUBLIC_POST_URL_PREFIX || 'post/%year%/%month%/%day%',
  ...
  ANALYTICS_GOOGLE_ID: process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'G-QNZ4Y23J10', // 谷歌Analytics的id e.g: G-XXXXXXXXXX
  ...
  SEO_BAIDU_SITE_VERIFICATION:
    process.env.NEXT_PUBLIC_SEO_BAIDU_SITE_VERIFICATION || 'codeva-XXwPngGyT4', // Remove the value or replace it with your own google site verification code

...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Hi,我在为成为程序员而不断努力,欢迎来到我的博客🎉',
  
  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || true, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Rainnn', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'bling bling ⭐', // 作者简介
  ...
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/rainnn-w', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  CHATBASE_ID: process.env.NEXT_PUBLIC_CHATBASE_ID || 'vum71mmUbv8hob_aLTR03',
  ...
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || 'bling bling ⭐', // 站点描述，被notion中的页面描述覆盖

...
const BLOG = {
  ...
  GREETING_WORDS:
    process.env.NEXT_PUBLIC_GREETING_WORDS ||'欢迎来到VC的网页',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'M24代言人VC', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '懒惰的YouTuber', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || '', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'M24代言人VC', // 网站关键词 英文逗号隔开
  ...
  CONTACT_INSTAGRAM: process.env.NEXT_PUBLIC_CONTACT_INSTAGRAM || 'https://www.instagram.com/m24_spokesperson_vc/profilecard/?igsh=MWVzeW51c2Q5Z2NxdA==', // 您的instagram地址
  CONTACT_BILIBILI: process.env.NEXT_PUBLIC_CONTACT_BILIBILI || '', // B站主页
  CONTACT_YOUTUBE: process.env.NEXT_PUBLIC_CONTACT_YOUTUBE || 'https://www.youtube.com/@M24VC', // Youtube主页
  ...
  // 文章URL前缀
  POST_URL_PREFIX: process.env.NEXT_PUBLIC_POST_URL_PREFIX ?? 'm24vc',
  ...
  WIDGET_PET_LINK:
    ...
    'https://raw.githubusercontent.com/imuncle/live2d/master/model/dollsfrontline/g41_2401/destroy/model.json', // 挂件模型地址 @see https://github.com/xiazeyu/live2d-widget-models
  ...
  SEO_GOOGLE_SITE_VERIFICATION:
    process.env.NEXT_PUBLIC_SEO_GOOGLE_SITE_VERIFICATION || 'ZfEn8Y7lWejqWfxlc-0dzrc3qS4EASd4wNa8l0XgGJE', // Remove the value or replace it with your own google site verification code
  ...
  IMG_COMPRESS_WIDTH: process.env.NEXT_PUBLIC_IMG_COMPRESS_WIDTH || 500, // Notion图片压缩宽度
  ...
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '这是一个由M24代言人VC生成的站点', // 站点描述，被notion中的页面描述覆盖

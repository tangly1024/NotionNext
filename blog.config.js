...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Breezedeus', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Breezedeus', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://breezedeus.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Breezedeus, CnOCR, CnSTD, Pix2Text, P2T, Mathpix, 数学公式识别, OCR, 算法, 开源, LLM, NLP, 深度学习, 机器学习', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个算法工程师, Hi，我是一个开源开发者, Hi，我是一个AI折腾的人, 我坚信，善意的AI能生产幸福❤️ ',
  ...
  ANALYTICS_BAIDU_ID: process.env.NEXT_PUBLIC_ANALYTICS_BAIDU_ID || 'e1229fa78fa8286e1ec52eee3bbadbb6', // e.g 只需要填写百度统计的id，[baidu_id] -> https://hm.baidu.com/hm.js?[baidu_id]
  ...
  IMG_COMPRESS_WIDTH: process.env.NEXT_PUBLIC_IMG_COMPRESS_WIDTH || 1000, // Notion图片压缩宽度
...
>>>>>>> e404e9c8 (Update blog.config.js)
}

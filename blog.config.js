...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Louis', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'A random dude in 40s', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion.kahosense.com', // 网站地址

...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Greta Donald', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Hey, I’m Greta Donald!I help business owners level up their digital systems, workflow, and productivity, so they can spend more time on what matters.', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://jjkl.pro', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, blog', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'wheicat@gmail.com', // 邮箱地址 例如mail@tangly1024.com

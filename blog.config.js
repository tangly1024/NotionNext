...
const BLOG = {
  ...
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || '3cb3f098fb7f4fde9d12ebd74c8e9473',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Zewen Chen (Erick)', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Student at University of Melbourne major in Master of IT', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.zewenchenerick.com/', // 网站地址

...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '8e4e60d0833d4861883aaa6672dca3c5,image:14e279d9f198800ca3defee2ceb66200',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Ayao', // 您的昵称 例如 tangly1024
  ...
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Information Central Hub,Ayao’s Information Central Hub,Ayao', // 网站关键词 英文逗号隔开
  ...
  WIDGET_PET_LINK:
    ...
    'https://cdn.jsdelivr.net/npm/live2d-widget-model/Violet/14.json', // 挂件模型地址 @see https://github.com/xiazeyu/live2d-widget-models
  ...
  ANALYTICS_GOOGLE_ID: process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'G-WTJQZJ1WYD', // 谷歌Analytics的id e.g: G-XXXXXXXXXX
  ...
  // 微软 Clarity 站点分析
  CLARITY_ID: process.env.NEXT_PUBLIC_CLARITY_ID || 'lwv0dpmqld', // 只需要复制Clarity脚本中的ID部分，ID是一个十位的英文数字组合
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'Ayao', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
    process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || '/bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || 'Ayao', // 站点描述，被notion中的页面描述覆盖

...
const BLOG = {
  ...
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || '593d08f6fc634d578f65aaae40ab6ad4',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'ortech', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚，欢迎你的到来我的网站', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.orys.link', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, orsrva', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'admin@orys.link', // 邮箱地址 例如mail@tangly1024.com
 // CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
 // CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/orsrva', // 你的github个人主页 例如 https://github.com/tangly1024
 ...
 // CONTACT_YOUTUBE: process.env.NEXT_PUBLIC_CONTACT_YOUTUBE || '', // Youtube主页
  ...
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || 'https://vercel.com/api/www/avatar/51b3c21eaf82c4b0c79cc95e97661cdcda0378ff?s=60', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  ...
  // 自定义外部脚本，外部样式
  CUSTOM_EXTERNAL_JS: ['https://topurl.cn/chat.js fold'], // e.g. ['http://xx.com/script.js','http://xx.com/script.js']
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '<a href="https://icp.gov.moe/?keyword=20230968" target="_blank">萌ICP备20230968号</a>', // 备案号 闽ICP备XXXXXXX
  ...
  MUSIC_PLAYER_AUDIO_LIST: [
    // 示例音乐列表。除了以下配置外，还可配置歌词，具体配置项看此文档 https://aplayer.js.org/#/zh-Hans/
    {
      ...
      url: 'https://music.163.com/#/song?id=569200213',
      cover:
  ...
  MUSIC_PLAYER_METING_SERVER:
        process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_SERVER || '163', // 音乐平台，[netease, tencent, kugou, xiami, baidu]
  MUSIC_PLAYER_METING_ID:
        process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_ID || '8394001869', // 对应歌单的 id
  ...
  // 作者配置
  AVATAR: process.env.NEXT_PUBLIC_AVATAR || 'https://github.com/orsrva', // 作者头像，被notion中的ICON覆盖。若无ICON则取public目录下的avatar.png
  TITLE: process.env.NEXT_PUBLIC_TITLE || '科技O', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:

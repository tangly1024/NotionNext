...
const BLOG = {
  API_BASE_URL: process.env.API_BASE_URL || 'https://difficult-report-1f2.notion.site/api/v3', // API默认请求地址,可以配置成自己的地址例如：https://[xxxxx].notion.site/api/v3
  // Important page_id！！！Duplicate Template from  https://tanghh.notion.site/02ab3b8678004aa69e9e415905ef32a5
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID || '277b95161b284cc895b1e94eff3cd632',
  ...
  GREETING_WORDS:
    ...
    'Modern Mathematics Enlightenment',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '现代数学启蒙', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '推广现代数学🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.math1234567.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '现代数学, 博客', // 网站关键词 英文逗号隔开

...
const BLOG = {
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '浙ICP备15007813号-1 | 浙公网安备 33082502000296号', // 备案号 闽ICP备XXXXXXX
  ...
  CONTACT_EMAIL: 'log@kvylin.com',
  CONTACT_WEIBO: '',
  CONTACT_TWITTER: '',
  CONTACT_GITHUB: 'https://github.com/kvylin',
  CONTACT_TELEGRAM: '',
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || '善思勤为', // 站点标题 ，被notion中的页面标题覆盖
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '余的记忆', // 站点描述，被notion中的页面描述覆盖

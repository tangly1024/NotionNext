...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一名医生, Hi，我是一名全科医生,Hi，我是一名公共卫生服务者,欢迎来到我的博客🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '无为', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一名全科医生🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://120819.xyz', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '家庭医生服务, 国家基本公共卫生服务,健康教育,重点人群管理,全科医生', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'hlwss@163.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || 'https://weibo.com/u/2792391085', // 你的微博个人主页
  ...
  CONTACT_WEHCHAT_PUBLIC: process.env.NEXT_PUBLIC_CONTACT_WEHCHAT_PUBLIC || 'https://mp.weixin.qq.com/mp/profile_ext?action=home&__biz=MjM5MTA1OTAwMg==#wechat_redirect', // 微信公众号 格式：https://mp.weixin.qq.com/mp/profile_ext?action=home&__biz=【xxxxxx】==#wechat_redirect
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '备案号 闽ICP备12081900号', // 备案号 闽ICP备XXXXXXX
  ...
  // 文章URL前缀
  tonst POST_URL_PREFIX: process.env.NEXT_PUBLIC_POST_URL_PREFIX ?? 'p',
  console.log('p_URL_PREFIX:', p_URL_PREFIX);  // 用于调试
  ...
  ANALYTICS_BAIDU_ID: process.env.NEXT_PUBLIC_ANALYTICS_BAIDU_ID || 'fc086816ee6e8188d8e66cf88f161b68', // e.g 只需要填写百度统计的id，[baidu_id] -> https://hm.baidu.com/hm.js?[baidu_id]
  ...
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '这是一个健康服务网站', // 站点描述，被notion中的页面描述覆盖

...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'ぶちまけちゃおうか 星に🌠','やけに白いんだ　やたら長いんだ
コタエはだいたいカタチばかりの常識だろう','あたしは生涯　あたしであってそれだけだろう'
  ...
  WIDGET_PET_LINK:
    ...
    'model/miku/miku.model.json', // 挂件模型地址 @see https://github.com/xiazeyu/live2d-widget-models 原来的茶杯犬:https://cdn.jsdelivr.net/npm/live2d-widget-model-wanko@1.0.5/assets/wanko.model.json

...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个i人, Hi，我是一个打工人,Hi，我是yipeng,欢迎来到我的博客🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'yipeng', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚科技互联网博主欢迎关注我', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://267888.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'yipeng, 博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'yipengtongxun@gmai.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  CONTACT_INSTAGRAM: prOCeSS.enV.NEXTPUBLIC_CONTACT_INSTAGRAM || '', // 的instagram地址
  CONTACT_BILIBILI: process.env.NEXT_PUBLIC_CONTACT_BILIBILI || '', // B站主页
  CONTACT_YOUTUBE: process.env.NEXT_PUBLIC_CONTAC_YOUTUBE || 'http://www.youtube.com/@yipeng888', // Youtube主页
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '美ICP备267888', // 备案号 闽ICP备XXXXXXX
  ...
  MUSIC_PLAYER_LRC_TYPE: process.env.NEXT_PUBLIC_MUSIC_PLAYER_LRC_TYPE || '1：lrc', // 歌词显示类型，可选值： 3 | 1 | 0（0：禁用 lrc 歌词，1：lrc 格式的字符串，3：lrc 文件 url）（前提是有配置歌词路径，对 meting 无效）
  ...
  // twikoo
  COMMENT_TWIKOO_ENV_ID: process.env.NEXT_PUBLIC_COMMENT_ENV_ID || 'pinglun-lemon.vercel.app', // TWIKOO后端地址 腾讯云环境填envId；Vercel环境填域名，教程：https://tangly1024.com/article/notionnext-twikoo
  ...
  COMMENT_UTTERRANCES_REPO:
    process.env.NEXT_PUBLIC_COMMENT_UTTERRANCES_REPO || 'xuxiansheng1017/pinglunUtterance, // 你的代码仓库名， 例如我是 'tangly1024/NotionNext'； 更多文档参考 https://utteranc.es/

...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '05a6689e82584e518d9c11e57b0b4df4',
  ...
  GREETING_WORDS:
    ...
    'Welcome to the code universe! This is a paradise for exploring, learning, and sharing programming techniques',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'HuaYang Tian', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.amoze.cc/', // 网站地址
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '冀ICP备2024076230号', // 备案号 闽ICP备XXXXXXX
  ...
  // 文章URL前缀
  POST_URL_PREFIX: process.env.NEXT_PUBLIC_POST_URL_PREFIX ?? 'article/%category%/%year%/%month%/%day%',
  ...
  WIDGET_PET_LINK:
    ...
    'https://cdn.jsdelivr.net/npm/live2d-widget-model-wanko@1.0.5/assets/model/miku/miku.model.json', // 挂件模型地址 @see https://github.com/xiazeyu/live2d-widget-models

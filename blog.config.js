...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'TAO', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '专注于前端开发', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'http://ctblog.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'ctblog, 陈涛', // 网站关键词 英文逗号隔开
  ...
  MUSIC_PLAYER_METING_ID:
    process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_ID || 'https://music.163.com/#/my/m/music/playlist?id=8625204321', // 对应歌单的 id

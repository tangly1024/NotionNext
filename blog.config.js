...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'NotionRen', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '为notion而生', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion.ren', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion教育版Plus,notion模板,notion小组件', // 网站关键词 英文逗号隔开
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '蜀ICP备2024088052号-3', // 备案号 闽ICP备XXXXXXX

...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '變態哥哥', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '變態集團董事長', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://abnormal-group.vercel.app/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '變態集團', // 网站关键词 英文逗号隔开

...
const BLOG = {
  ...
  NOTION_PAGE_ID:
      process.env.NOTION_PAGE_ID || '455841bd1ef44ae58f0f954b329c565d',
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '一个喜欢做梦的硬件工程师😋', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://matrixcore.top', // 网站地址
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '萌ICP备20260420', // 备案号 闽ICP备XXXXXXX
  ...
  MUSIC_PLAYER_METING_SERVER:
      process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_SERVER || 'tecent', // 音乐平台，[netease, tencent, kugou, xiami, baidu]
  MUSIC_PLAYER_METING_ID:
      process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_ID || '8556483453', // 对应歌单的 id
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'Matrix Core', // 站点标题 ，被notion中的页面标题覆盖
  HOME_BANNER_IMAGE:
      process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || './bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
      process.env.NEXT_PUBLIC_DESCRIPTION || '少年辛苦终身事 莫向光阴惰寸功', // 站点描述，被notion中的页面描述覆盖

...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'chentao', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一位前端全栈工程师', // 作者简介
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || <a href="https://icp.gov.moe/?keyword=20242207" target="_blank">萌ICP备20242207号</a>, // 备案号 闽ICP备XXXXXXX

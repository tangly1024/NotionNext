...
const BLOG = {
  ...
  API_BASE_URL: process.env.API_BASE_URL || 'https://better-resonance-00b.notion.site/api/v3', // API默认请求地址
  NOTION_PAGE_ID:
  ...
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion,博客,黄昊霆,黄昊霆的博客,hhtb.cn,https://hhtb.cn/', // 网站关键词 英文逗号隔开

...
const BLOG = {
  ...
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || 'bbe6e715b6ea470fa00a432c1bff651e',
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'loyal to myself.',
  ...
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/VamRed', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || 'https://photos.vama.uk/file/3ad0912d6fb8d89ac7af0.jpg', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  ...
  // 自定义外部脚本，外部样式
  CUSTOM_EXTERNAL_JS: ['https://cdn.jsdelivr.net/gh/VamRed/ai_zzy@2/cdn/disabled.js'], // e.g. ['http://xx.com/script.js','http://xx.com/script.js']
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '浙ICP备10020930', // 备案号 闽ICP备XXXXXXX
  ...
  MUSIC_PLAYER_METING_SERVER:
        process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_SERVER || '', // 音乐平台，[netease, tencent, kugou, xiami, baidu]
  ...
  COMMENT_ARTALK_JS: process.env.NEXT_PUBLIC_COMMENT_ARTALK_JS || '', // ArtalkServert js cdn
  COMMENT_ARTALK_CSS: process.env.NEXT_PUBLIC_COMMENT_ARTALK_CSS || '', // ArtalkServert css cdn
  ...
  COMMENT_GISCUS_MAPPING:
        process.env.NEXT_PUBLIC_COMMENT_GISCUS_MAPPING || '', // 你的Github Discussions 使用哪種方式來標定文章, 預設 'pathname'
  ...
  COMMENT_GISCUS_LOADING:
        process.env.NEXT_PUBLIC_COMMENT_GISCUS_LOADING || '', // 你的 Giscus 載入是否漸進式載入, 預設 'lazy'
  ...
  COMMENT_GITALK_JS_CDN_URL: process.env.NEXT_PUBLIC_COMMENT_GITALK_JS_CDN_URL || '', // gitalk客户端 js cdn
  COMMENT_GITALK_CSS_CDN_URL: process.env.NEXT_PUBLIC_COMMENT_GITALK_CSS_CDN_URL || '', // gitalk客户端 css cdn

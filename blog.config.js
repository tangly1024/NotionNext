...
const BLOG = {
  ...
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '铁牛爱分享, 铁牛博客', // 网站关键词 英文逗号隔开
  ...
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/niustark', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  CONTACT_BILIBILI: process.env.NEXT_PUBLIC_CONTACT_BILIBILI || 'https://space.bilibili.com/1376800672/', // B站主页
  CONTACT_YOUTUBE: process.env.NEXT_PUBLIC_CONTACT_YOUTUBE || 'https://y.music.163.com/m/user?id=7895102497', // Youtube主页
  ...
  FONT_AWESOME: process.env.NEXT_PUBLIC_FONT_AWESOME_PATH || ['https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css','https://at.alicdn.com/t/c/font_2246922_h87gsgxbr6.css'] // font-awesome 字体图标地址; 可选 /css/all.min.css ， https://lf9-cdn-tos.bytecdntp.com/cdn/expire-1-M/font-awesome/6.0.0/css/all.min.css

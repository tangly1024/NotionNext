...
const BLOG = {
  ...
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || 'cb9d51b3be09416ca251c3a3bce31c4c',
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，我是一个猫头人, Hi，我是一只猫,Hi，我是一个野生金融学家,欢迎来到我的博客🎉',

  AUTHOR: '猫总CATMAN', // 作者
  BIO: '就是只普通的猫头人🐱', // 作者简介
  LINK: 'https://catman.app', // 网站地址
  KEYWORDS: '移民,投资,房地产,基金,证券,', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''support@keihan.co
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'support@keihan.co', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || 'https://twitter.com/catmangox', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || '', // 你的github个人主页 例如 https://github.com/tangly1024
  CONTACT_TELEGRAM: process.env.NEXT_PUBLIC_CONTACT_TELEGRAM || 'https://t.me/catmanapp', // 你的telegram 地址 例如 https://t.me/tangly_1024
  ...
  COMMENT_CUSDIS_APP_ID: process.env.NEXT_PUBLIC_COMMENT_CUSDIS_APP_ID || 'fadd91bd-2886-45ce-8965-8d0b87053f8c', // data-app-id 36位 see https://cusdis.com/
  COMMENT_CUSDIS_HOST:

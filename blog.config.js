...
const BLOG = {
  ...
  // 开发相关
  NOTION_ACCESS_TOKEN: process.env.NOTION_ACCESS_TOKEN || 'secret_gqc76NMIjRkj3N92RLHEBvkIP3MnhAZE053xqzS32PA', // Useful if you prefer not to make your database public

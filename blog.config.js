...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '12269776e204800fb463ddb6af4a9b1f,en:7c1d570661754c8fbc568e00a01fd70e',
  ...
  GREETING_WORDS:
    ...
    'Hi，我可能是一个程序员, Hi，我可能是一个摄影师, Hi，我可能是一个打工人, 总之欢迎来到我的博客🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Richard Liu', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一条咸鱼', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.richardliuda.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '2645345468@qq.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB:
    process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/RichardLiuda', // 你的github个人主页 例如 https://github.com/tangly1024
  CONTACT_TELEGRAM: process.env.NEXT_PUBLIC_CONTACT_TELEGRAM || '', // 你的telegram 地址 例如 https://t.me/tangly_1024
  CONTACT_LINKEDIN: process.env.NEXT_PUBLIC_CONTACT_LINKEDIN || '', // 你的linkedIn 首页
  CONTACT_INSTAGRAM:
    process.env.NEXT_PUBLIC_CONTACT_INSTAGRAM ||
    'https://www.instagram.com/richard_liu_114514/', // 您的instagram地址
  CONTACT_BILIBILI:
    process.env.NEXT_PUBLIC_CONTACT_BILIBILI ||
    'https://space.bilibili.com/165409970', // B站主页
  CONTACT_YOUTUBE: process.env.NEXT_PUBLIC_CONTACT_YOUTUBE || '', // Youtube主页
  CONTACT_XIAOHONGSHU:
    process.env.NEXT_PUBLIC_CONTACT_XIAOHONGSHU ||
    'https://www.xiaohongshu.com/user/profile/64e3500b000000000100f79c', // 小红书主页
  ...
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/486.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png

  IMAGE_COMPRESS_WIDTH: process.env.NEXT_PUBLIC_IMAGE_COMPRESS_WIDTH || 3840, // 图片压缩宽度默认值，作用于博客封面和文章内容 越小加载图片越快
  IMAGE_ZOOM_IN_WIDTH: process.env.NEXT_PUBLIC_IMAGE_ZOOM_IN_WIDTH || 3840, // 文章图片点击放大后的画质宽度，不代表在网页中的实际展示宽度
  ...
  BACKGROUND_LIGHT: '#E0F0FF', // use hex value, don't forget '#' e.g #fffefc
  BACKGROUND_DARK: '#2F3F4F', // use hex value, don't forget '#'
  ...
  MUSIC_PLAYER_METING_ID:
    process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_ID || '6815445130', // 对应歌单的 id
  ...
  COMMENT_TWIKOO_ENV_ID:
    process.env.NEXT_PUBLIC_COMMENT_ENV_ID || 'https://twikoo.richardliuda.top', // TWIKOO后端地址 腾讯云环境填envId；Vercel环境填域名，教程：https://tangly1024.com/article/notionnext-twikoo
  ...
  ANALYTICS_GOOGLE_ID:
    process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'G-4ZV4EZXQT1', // 谷歌Analytics的id e.g: G-XXXXXXXXXX
  ...
  // 微软 Clarity 站点分析
  CLARITY_ID: process.env.NEXT_PUBLIC_CLARITY_ID || q97i2wcwz0, // 只需要复制Clarity脚本中的ID部分，ID是一个十位的英文数字组合

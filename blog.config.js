...
const BLOG = {
  ...
  COMMENT_GISCUS_REPO_ID:
    process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO_ID || 'R_kgDOJKDQFw', // 你的Github Repo ID e.g ( 設定完 giscus 即可看到 )
  COMMENT_GISCUS_CATEGORY_ID:
    process.env.NEXT_PUBLIC_COMMENT_GISCUS_CATEGORY_ID ||
    'DIC_kwDOJKDQF84CU53u', // 你的Github Discussions 內的 Category ID ( 設定完 giscus 即可看到 )

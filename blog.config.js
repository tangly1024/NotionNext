...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '谁与同坐？明月清风我。, 与君初相见，犹见故人归。, 风触好花文锦落，砌横流水玉琴斜。',
  ...
  CHATBASE_ID: process.env.NEXT_PUBLIC_CHATBASE_ID || "9J92QC1-KDptwBQBC86BT",
  ...
  // twikoo
  COMMENT_TWIKOO_ENV_ID: process.env.NEXT_PUBLIC_COMMENT_ENV_ID || 'twikoo.andykong.top', // TWIKOO后端地址 腾讯云环境填envId；Vercel环境填域名，教程：https://tangly1024.com/article/notionnext-twikoo

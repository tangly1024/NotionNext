...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '小小校园', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个专注于学习和个人成长的在线平台', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.xiaoxiaoxiaoyuan.top/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '校园，服务，平台', // 网站关键词 英文逗号隔开

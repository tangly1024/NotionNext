...
const BLOG = {
  AUTHOR: 'sswin', // 作者
  BIO: '一个普通的干饭人🍚', // 作者简介
  LINK: 'https://notionblog.sswin.xyz', // 网站地址
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'Sswin‘s BLOG', // 站点标题 ，被notion中的页面标题覆盖
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || 'Sswin的小站', // 站点描述，被notion中的页面描述覆盖

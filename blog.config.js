...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'niusea', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Cici', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'http://www.niusea.com/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '产品定制...', // 网站关键词 英文逗号隔开

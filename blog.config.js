...
const BLOG = {
  ...
  RANDOM_IMAGE_REPLACE_TEXT:
    ...
    'https://cdn.seovx.com/d/?mom=302', // 触发替换图片的 url 关键字(多个支持用英文逗号分开)，只有图片地址中包含此关键字才会替换为上方随机图片url
  ...
  ANALYTICS_BAIDU_ID: process.env.NEXT_PUBLIC_ANALYTICS_BAIDU_ID || 'e.g 15c4e67adb8a2504c5cefaa6ddb9841f', // e.g 只需要填写百度统计的id，[baidu_id] -> https://hm.baidu.com/hm.js?[baidu_id]
  ...
  IMG_URL_TYPE: process.env.NEXT_PUBLIC_IMG_TYPE || 'https://cdn.seovx.com/d/?mom=302', // 此配置已失效，请勿使用；AMAZON方案不再支持，仅支持Notion方案。 ['Notion','AMAZON'] 站点图片前缀 默认 Notion:(https://notion.so/images/xx) ， AMAZON(https://s3.us-west-2.amazonaws.com/xxx)

...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '1613f482a46b809cbadfcc712a0fe993,en:1613f482a46b809cbadfcc712a0fe993',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '阿辉', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '深渊阳光🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://docs.52day.top/', // 网站地址
  ...
  ANALYTICS_GOOGLE_ID: process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'G-RVX7QKHWZP', // 谷歌Analytics的id e.g: G-XXXXXXXXXX

  // 51la 站点统计 https://www.51.la/
  ANALYTICS_51LA_ID: process.env.NEXT_PUBLIC_ANALYTICS_51LA_ID || 'KfPjAHMC7kLzQIiN', // id，在51la后台获取 参阅 https://docs.tangly1024.com/article/notion-next-51-la
  ANALYTICS_51LA_CK: process.env.NEXT_PUBLIC_ANALYTICS_51LA_CK || 'KfPjAHMC7kLzQIiN', // ck，在51la后台获取
  ...
  // 微软 Clarity 站点分析
  CLARITY_ID: process.env.NEXT_PUBLIC_CLARITY_ID || 'pgpajfcttr', // 只需要复制Clarity脚本中的ID部分，ID是一个十位的英文数字组合

...
const BLOG = {
  AUTHOR: 'Zealer G', // 作者
  BIO: '事常与人违，事总在人为', // 作者简介
  LINK: 'https://notion-blog.zealerg.top', // 网站地址
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '闽ICP备2022004234号', // 备案号 闽ICP备XXXXXXX
  ...
  CONTACT_EMAIL: 'mail@zealerg@126.com',
  CONTACT_WEIBO: '',
  CONTACT_TWITTER: '',
  CONTACT_GITHUB: 'https://github.com/zealerg',
  CONTACT_TELEGRAM: '',
  ...
  COMMENT_WALINE_SERVER_URL: process.env.NEXT_PUBLIC_WALINE_SERVER_URL || 'https://notion-blog-waline-r0tn0uju9-zealerg.vercel.app/', // Waline 评论 @see https://waline.js.org/guide/get-started.html

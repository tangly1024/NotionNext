...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '2a2f7026d6674bd19c5aec3c94bfd453,en-US:13e00092b9778002a3e2d5278bab3cd9', // 中文数据库,英文数据库
  ...
  NEXT_REVALIDATE_SECOND: process.env.NEXT_PUBLIC_REVALIDATE_SECOND || 14400, // 默认 ISR 重建间隔提升为 4 小时，避免低价值页面在持续访问下频繁触发 ISR Writes。

...
const BLOG = {
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://zy.hhzy.us.kg/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '口合, 博客', // 网站关键词 英文逗号隔开

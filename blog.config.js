...
const BLOG = {
  ...
  NOTION_PAGE_ID:
      process.env.NOTION_PAGE_ID || '2bd1e70392554d308b2e099f0b622b66',
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'geeks7i欢迎您, 欢迎来到我的博客🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Gus7i', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Just for fun', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.geeks7i.cool', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 's7i, geeks7i', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '66955249@qq.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  WIDGET_PET_LINK:
      ...
      'https://cdn.jsdelivr.net/npm/live2d-widget-model-epsilon2_1/assets/Epsilon2.1.model.jso', // 挂件模型地址 @see https://github.com/xiazeyu/live2d-widget-models

...
const BLOG = {
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.gaoqilan.tech', // 网站地址
  ...
  WIDGET_PET_LINK:
    ...
    'https://cdn.jsdelivr.net/npm/live2d-widget-model-dollsfrontline/assets/golden/model1.json', // 挂件模型地址 @see https://github.com/xiazeyu/live2d-widget-models

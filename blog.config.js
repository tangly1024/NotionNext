...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '184b7c6a5b6a809f9cabe1e24a3bdb50,en:7c1d570661754c8fbc568e00a01fd70e',
  THEME: process.env.NEXT_PUBLIC_THEME || 'mageine', // 当前主题，在themes文件夹下可找到所有支持的主题；主题名称就是文件夹名，例如 example,fukasawa,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'stickland', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '靡不有初，鲜克有终', // 作者简介

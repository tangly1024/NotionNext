...
const BLOG = {
  ...
  FONT_URL: [
    ...
    'https://fonts.googleapis.com/css?family=Apple+Color+Emoji:wght@300&display=swap',
  ...
  SEO_BAIDU_SITE_VERIFICATION: process.env.SEO_BAIDU_SITE_VERIFICATION || 'codeva-nYeGV7cEeE', // 百度站长平台的站点验证
  // <---- 站点统计

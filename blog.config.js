...
const BLOG = { 
  ...
  // 自定义外部脚本，外部样式
  CUSTOM_EXTERNAL_JS: ['https://cdn.jsdelivr.net/gh/VamRed/ai_zzy@1/cdn/snow.js','https://cdn.jsdelivr.net/gh/VamRed/ai_zzy@1/cdn/disabled.js'], // e.g. ['http://xx.com/script.js','http://xx.com/script.js']

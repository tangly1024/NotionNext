...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Cavint Blog', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '学无止境', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://burjuman.xyz', // 网站地址

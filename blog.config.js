...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'RJL 博客', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干🍚人', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://boke.raojailong6.asia/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'RJL , 博客', // 网站关键词 英文逗号隔开
  ...
  MUSIC_PLAYER_METING_ID:
        process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_ID || '9093657190', // 对应歌单的 id

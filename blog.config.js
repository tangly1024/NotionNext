...
const BLOG = {
      ...
      NOTION_PAGE_ID:
            process.env.NOTION_PAGE_ID || '6a3d274644eb4105a7cf01b196157ebe',
      ...
      GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，我是落幕，一名独立开发者, Hi，我是落幕，一名前后端开发工程师,Hi，我是落幕，一名产品经理,🎉',
    
      CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || true, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。
    
      AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '落幕', // 您的昵称 例如 tangly1024
      BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的老板🍚', // 作者简介
      LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.i-free.link', // 网站地址
      KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Orange-Love-Freedom，橙爱自由LLC', // 网站关键词 英文逗号隔开
    
      // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
      CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '2924846542@qq.com', // 邮箱地址 例如mail@tangly1024.com
      CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
      CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
      CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/orangeX21', // 你的github个人主页 例如 https://github.com/tangly1024
      CONTACT_TELEGRAM: process.env.NEXT_PUBLIC_CONTACT_TELEGRAM || 'https://t.me/OrangeX21', // 你的telegram 地址 例如 https://t.me/tangly_1024
      ...
      BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/kunkunyu.png', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png

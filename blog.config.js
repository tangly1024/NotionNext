...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '小太阳昌仔', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '平静的努力，精致的执着🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.ssuncz.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '小太阳昌仔blog, 小太阳昌仔, 小太阳昌仔博客', // 网站关键词 英文逗号隔开
  ...
  POSTS_SHARE_SERVICES: process.env.NEXT_PUBLIC_POST_SHARE_SERVICES || 'link,wechat,qq,weibo,email,twitter,telegram,whatsapp', // 分享的服務，按顺序显示,逗号隔开
  ...
  FIREWORKS_COLOR: [
    '230, 20, 97',   //调低了红色,变为粉红
    '24, 255, 160',   //提高了绿色的饱和度,更鲜艳
    '100, 155, 255',   //蓝色较深,更 stealth
    '251, 243, 160'   //黄色也提高了饱和度,但维持较浅色
  ],
  """以下个人备注，为默认色彩，上面色彩是通过ai生成
    '255, 20, 97',
    '24, 255, 146',
    '90, 135, 255',
    '251, 243, 140'

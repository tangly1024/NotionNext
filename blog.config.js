...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Simo54', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'old coder | 代码搬运专家 | Ctrl C+V布道者', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://simo54.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '程序员,blog,博客,自媒体,公众号,独立开发,simo54,Simo54', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'y279336671@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  CONTACT_WEHCHAT_PUBLIC: process.env.NEXT_PUBLIC_CONTACT_WEHCHAT_PUBLIC || 'https://mp.weixin.qq.com/mp/profile_ext?action=home&__biz=Mzk0OTc0MjQwOA==#wechat_redirect', // 微信公众号 格式：https://mp.weixin.qq.com/mp/profile_ext?action=home&__biz=【xxxxxx】==#wechat_redirect
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '京ICP备19053452号', // 备案号 闽ICP备XXXXXXX
  ...
  HOME_BANNER_IMAGE:
    process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || '', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:

...
const BLOG = {
  ...
  POST_URL_PREFIX: process.env.NEXT_PUBLIC_POST_URL_PREFIX || 'article/%category%',
  ...
  COMMENT_TWIKOO_CDN_URL: process.env.NEXT_PUBLIC_COMMENT_TWIKOO_CDN_URL || 'https://cdn.staticfile.net/twikoo/1.6.31/twikoo.min.js', // twikoo客户端cdn

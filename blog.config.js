...
const BLOG = {
  ...
  APPEARANCE_DARK_TIME: process.env.NEXT_PUBLIC_APPEARANCE_DARK_TIME || [22, 5], // 夜间模式起至时间，false时关闭根据时间自动切换夜间模式
  ...
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_KEYWORD || '', // 邮箱地址 例如mail@tangly1024.com

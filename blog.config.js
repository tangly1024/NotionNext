...
const BLOG = {
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion.deqiang.wang', // 网站地址
  ...
  DESCRIPTION: process.env.NEXT_PUBLIC_DESCRIPTION || '知识管理', // 站点描述，被notion中的页面描述覆盖

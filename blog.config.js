...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Monkey007', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个努力干饭的打工人', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.yufaxiaoyuan.top/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 语法,学习,教程,付费', // 网站关键词 英文逗号隔开
  ...
  COMMENT_CUSDIS_SCRIPT_SRC:
    process.env.NEXT_PUBLIC_COMMENT_CUSDIS_SCRIPT_SRC || 'https://cusdis.com/js/widget/lang/zh-cn.js', // change this if you're using self-hosted version

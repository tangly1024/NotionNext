...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'JinSo', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Something good will happen to you today!', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://jinso365.top', // 网站地址
  ...
  PRISM_THEME_LIGHT_PATH: process.env.NEXT_PUBLIC_PRISM_THEME_LIGHT_PATH || '/css/prism-one-light.css', // 浅色模式主题
  PRISM_THEME_DARK_PATH: process.env.NEXT_PUBLIC_PRISM_THEME_DARK_PATH || '/css/prism-one-dark.css', // 深色模式主题

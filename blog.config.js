...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '❀缘聚缘散缘如水,背负万丈尘寰,只为一句,等待下一次相逢', // 作者简介
  ...
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/lzk821', // 你的github个人主页 例如 https://github.com/tangly1024

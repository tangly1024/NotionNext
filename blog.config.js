...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Welcome to Goldenbuds!', '以品质求生存，以服务谋发展，为客户创价值', 'Survive by quality, develop by service, and create value for customers.'
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || 'To grow with GoldenBuds, and grow like golden buds', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.goldenbuds.online', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Goldenbuds，manufacturer, LED Grow Lights, indoor farming lights，vertical planting LED bar lights, mobiles and accessories, electronics', // 网站关键词 英文逗号隔开
  ...
  // twikoo
  COMMENT_TWIKOO_ENV_ID: process.env.NEXT_PUBLIC_COMMENT_ENV_ID || 'https://twikoo.msvr.us.kg', // TWIKOO后端地址 腾讯云环境填envId；Vercel环境填域名，教程：https://tangly1024.com/article/notionnext-twikoo
  ...
  ANALYTICS_GOOGLE_ID: process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'G-JPC1Z78YL1', // 谷歌Analytics的id e.g: G-XXXXXXXXXX
  ...
  SEO_GOOGLE_SITE_VERIFICATION:
    process.env.NEXT_PUBLIC_SEO_GOOGLE_SITE_VERIFICATION || 'pDVyH1KPaLBtO0qUTeuL0nC8uCh-QVqK67lzsQw3Skw', // Remove the value or replace it with your own google site verification code
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'GoldenBuds Blog', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
    process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || '/bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || 'Goldenbuds is a professional LED Grow Lights manufacturer.', // 站点描述，被notion中的页面描述覆盖

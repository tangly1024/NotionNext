...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一名在校大学生,热衷于记录和分享学习笔记和生活工具,欢迎来到我的博客🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '之华', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个编程小白', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://zhihua.vip', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '之华的个人博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '507140388@qq.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/water-aw', // 你的github个人主页 例如 https://github.com/tangly1024
...
=======
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://zhihua.vip', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, 嵌入式', // 网站关键词 英文逗号隔开

  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || 'https://siyuan-xzq.oss-cn-shenzhen.aliyuncs.com/siyuan/20250317161645.jpg', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png

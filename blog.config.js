...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Jim Deng', // 您的昵称
  BIO: process.env.NEXT_PUBLIC_BIO || 'a backend engineer and AI developer', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://jimdeng.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, Technology, AIGC, Agent, Developer', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    'I\'m a backend developer passionate about building robust and efficient systems, I\'m deeply interested in AIGC and happy to share new technologies and insights in this field, Feel free to connect or collaborate!',

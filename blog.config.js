...
const BLOG = {
  ...
  THEME: process.env.NEXT_PUBLIC_THEME || 'starter', // 锁定默认主题为starter
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://aaaaaaaa123.vercel.app/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'ChinAfrica, Logistics', // 网站关键词 英文逗号隔开

...
const BLOG = {
  ...
  MUSIC_PLAYER_AUDIO_LIST: [
    // 示例音乐列表。除了以下配置外，还可配置歌词，具体配置项看此文档 https://aplayer.js.org/#/zh-Hans/
    {
      name: 'Flower Dance',
      artist: 'DJOKAWARI',
      url: 'https://img2.sanye.us.kg/sanye/Flower%20Dance%20-%20DJ%20OKAWARI.mp3',
      cover:
        'https://img2.sanye.us.kg/sanye/Snipaste_2024-11-24_20-16-38.png'
    },
    {
      name: '記憶',
      artist: '市川淳',
  ...
  // twikoo
  COMMENT_TWIKOO_ENV_ID: process.env.NEXT_PUBLIC_COMMENT_ENV_ID || 'twikoo.sanye.us.kg', // TWIKOO后端地址 腾讯云环境填envId；Vercel环境填域名，教程：https://tangly1024.com/article/notionnext-twikoo

...
const BLOG = {
  ...
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, 没用的小废鼠', // 网站关键词 英文逗号隔开
  ...
  COMMENT_TWIKOO_CDN_URL:
    process.env.NEXT_PUBLIC_COMMENT_TWIKOO_CDN_URL || 'https://unpkg.com/twikoo/dist/twikoo.all.min.js', // twikoo客户端cdn
  ...
  DESCRIPTION: process.env.NEXT_PUBLIC_DESCRIPTION || '做学问可不是赶潮流、没有冷门热门之说。', // 站点描述，被notion中的页面描述覆盖

...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Vica', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个新时代无产者🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.inpx.win', // 网站地址

...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '肖自在', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '肖自在的个人主页，记录个人学习笔记，记录生活，记录在伯恩半导体的工作，欢迎半导体采购、销售加我微信，加群交流。', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://ixzz.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '肖自在的个人主页', // 网站关键词 英文逗号隔开

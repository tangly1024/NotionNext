...
const BLOG = {
  ...
  NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || 'c614627caf66469dbeca8232a06be2fa',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '颂雅风', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '学习知识，记录经验，传承文化', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.studyai.ltd/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'yadinae@gmail.com', // 邮箱地址 例如mail@tangly1024.com

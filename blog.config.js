...
const BLOG = {
  ...
  KEYWORDS:
    process.env.NEXT_PUBLIC_KEYWORD || '虾滑, 滑雪, chill, 单板滑雪, 双板滑雪', // 网站关键词 英文逗号隔开
  ...
  CONTACT_INSTAGRAM:
    ...
    'https://www.instagram.com/shredxhub/', // 您的instagram地址
  ...
  COMMENT_GITTER_ROOM:
    ...
    'https://matrix.to/#/!mDTbDrANZTqoDVUMlT:gitter.im?via=gitter.im', // gitter聊天室 see https://gitter.im/ 不需要则留空
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || '虾滑|Shredhub', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
    process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || '/bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '虾滑滑雪社群的主页', // 站点描述，被notion中的页面描述覆盖

...
const BLOG = {
  AUTHOR: '黑李白', // 作者
  BIO: '一个普通的干饭人🍚', // 作者简介
  LINK: 'https://blog.ibolee.com', // 网站地址
  KEYWORDS: '黑李白,黑李白的博客', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  process.env.NOTION_PAGE_ID || '616e6e4e2dde40ffa56f69e3e22b2237', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  ...
  LANG: 'zh-CN', ,'en-US'// e.g 'zh-CN','en-US'  see /lib/lang.js for more.
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '蒙ICP备2021000620号', // 备案号 闽ICP备XXXXXXX

...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    '我是一名痴迷于计算机技术的高中生,青云制作_彭明航,很荣幸能在这里与你相遇,欢迎访问我的博客园🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '青云制作_彭明航', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一名痴迷于计算机技术无法自拔的高中生', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://pmhs.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'blog,博客,彭明航,pmh,明航博客园,博客园,青云,青云制作,青云制作_彭明航,明航', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'pmh13182190482@yeah.net', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/pmh1314520', // 你的github个人主页 例如 https://github.com/tangly1024
  CONTACT_TELEGRAM: process.env.NEXT_PUBLIC_CONTACT_TELEGRAM || '', // 你的telegram 地址 例如 https://t.me/tangly_1024
  CONTACT_LINKEDIN: process.env.NEXT_PUBLIC_CONTACT_LINKEDIN || '', // 你的linkedIn 首页
  CONTACT_INSTAGRAM: process.env.NEXT_PUBLIC_CONTACT_INSTAGRAM || '', // 您的instagram地址
  CONTACT_BILIBILI: process.env.NEXT_PUBLIC_CONTACT_BILIBILI || 'https://space.bilibili.com/1102546347?spm_id_from=333.1007.0.0', // B站主页
  ...
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || 'https://www.notion.so/image/https%3A%2F%2Fprod-files-secure.s3.us-west-2.amazonaws.com%2Fe2841ae9-6071-45cc-90fc-eba88db939d0%2F475d306e-6847-4335-818f-2fc97de7ac32%2Ficons8-%25E6%2589%2593%25E5%25AD%2597%25E6%259C%25BA%25E5%2592%258C%25E7%25BA%25B8-96.png?id=147e67ff-2fe9-8178-9241-000b36c1286f&table=collection&spaceId=e2841ae9-6071-45cc-90fc-eba88db939d0&width=60&userId=13cd872b-594c-819d-a236-0002332309eb&cache=v2', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '萌ICP备20245948号', // 备案号 闽ICP备XXXXXXX
  ...
  MUSIC_PLAYER_METING_ID:
    process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_ID || '8891548117', // 对应歌单的 id
  ...
  COMMENT_UTTERRANCES_REPO:
    process.env.NEXT_PUBLIC_COMMENT_UTTERRANCES_REPO || 'pmh1314520/NotionNext', // 你的代码仓库名， 例如我是 'tangly1024/NotionNext'； 更多文档参考 https://utteranc.es/

  // giscus @see https://giscus.app/
  COMMENT_GISCUS_REPO: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO || 'pmh1314520/NotionNext', // 你的Github仓库名 e.g 'tangly1024/NotionNext'
  ...
  COMMENT_GITALK_OWNER: process.env.NEXT_PUBLIC_COMMENT_GITALK_OWNER || 'pmh1314520', // 你的用户名 e.g tangly1024
  COMMENT_GITALK_ADMIN: process.env.NEXT_PUBLIC_COMMENT_GITALK_ADMIN || '青云制作_彭明航', // 管理员用户名、一般是自己 e.g 'tangly1024'
  COMMENT_GITALK_CLIENT_ID:
    process.env.NEXT_PUBLIC_COMMENT_GITALK_CLIENT_ID || 'Ov23li3LZ7FDuu9Akoim', // e.g 20位ID ， 在gitalk后台获取
  COMMENT_GITALK_CLIENT_SECRET:
    process.env.NEXT_PUBLIC_COMMENT_GITALK_CLIENT_SECRET || '4e0913390cdf65a20a00a42a6c5d97c4ac8cc25b', // e.g 40位ID， 在gitalk后台获取
  ...
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '一个分享计算机综合技术的地方', // 站点描述，被notion中的页面描述覆盖

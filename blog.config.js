...
const BLOG = {
  ...
  NOTION_SYNC_RECORD_ENDPOINT_MODE:
    process.env.NOTION_SYNC_RECORD_ENDPOINT_MODE || 'auto', // syncRecordValues 接口兼容模式：auto/main/legacy
  // Important page_id！！！Duplicate Template from  https://tanghh.notion.site/02ab3b8678004aa69e9e415905ef32a5
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID ||
    '2992bea15d08817c971fd04a5fb64e03,en:2992bea15d08817c971fd04a5fb64e03',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'pcl2design.site', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://tangly1024.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/favicon.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '沪ICP备2025113665号', // 备案号 闽ICP备XXXXXX
  ...
  // 自定义菜单
  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU ?? true, // 开启完全自定义菜单（Menu类型），替代3.12版本前的Page类型

...
const BLOG = {
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://xifanliang.xyz', // 网站地址
  ...
  WIDGET_PET_LINK: process.env.NEXT_PUBLIC_WIDGET_PET_LINK || 'https://fastly.jsdelivr.net/gh/stevenjoezhang/live2d-widget@latest/autoload.js', // 挂件模型地址 @see https://github.com/xiazeyu/live2d-widget-models

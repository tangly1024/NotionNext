...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '東', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '日常随笔', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://lxd326.eu.org', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '東, 博客', // 网站关键词 英文逗号隔开

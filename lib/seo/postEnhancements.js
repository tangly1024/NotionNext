...
const POST_ENHANCEMENTS = {
  ...
  'en-us/article/agent': {
    seoTitle:
      'AI Agent Tools Comparison 2026: FastGPT vs Dify vs Coze for RAG and Knowledge Base Workflows',
    seoDescription:
      'Compare FastGPT, Dify, and Coze for AI agent, RAG, and knowledge base workflows. See differences in deployment speed, customization, workflow design, and which tool fits your team in 2026.',
    heroSummary:
      'A comparison of AI agent tools and knowledge base builders, focused on workflow design, RAG, deployment speed, and customization.',
    ...
    relatedLinks: [
      ...
      {
        title: 'Why OpenAI Abandoned Sora',
        href: '/en-US/article/openai-sora-shutdown-10yi-lesson',
        description:
          'A product strategy case study on why technical leadership does not guarantee distribution.'
      }
    ]
  },
  'article/agent': {
    seoTitle:
      'AI Agent Tools Comparison 2026: FastGPT vs Dify vs Coze for RAG and Knowledge Base Workflows',
    seoDescription:
      'Compare FastGPT, Dify, and Coze for AI agent, RAG, and knowledge base workflows. Review deployment speed, customization, workflow design, and which tool is best for teams building AI assistants in 2026.',
    heroSummary:
      'A comparison of AI agent tools and knowledge base builders, focused on workflow design, RAG, deployment speed, and customization.',
    intentTitle: 'What you will learn',
    intentText:
  ...
  'en-us/article/openclaw-ai-assistant-framework-2026': {
    seoTitle:
      'OpenClaw AI Assistant 2026: Official Docs, GitHub, Framework Architecture and Personal AI Assistant Guide',
    seoDescription:
      'Explore the OpenClaw AI assistant framework in 2026, including official docs style guidance on GitHub context, architecture, updates, use cases, and how to build a personal AI assistant workflow with it.',
    heroSummary:
      'A practical OpenClaw guide covering framework structure, personal AI assistant use cases, GitHub positioning, and how to evaluate it in 2026.',
    intentTitle: 'Why this OpenClaw guide is useful',
    intentText:
      'This page is for builders searching for OpenClaw official documentation, framework overviews, GitHub context, and practical ways to evaluate OpenClaw as a personal AI assistant stack in 2026.',
    relatedLinks: [
      {
        title: 'AI Agent Tools Comparison',
        href: '/article/Agent',
  ...
  'article/ai-agent-programming-2026': {
    ...
    relatedLinks: [
      ...
      {
        title: 'Why OpenAI Shut Down Sora',
        href: '/en-US/article/openai-sora-shutdown-10yi-lesson',
        description:
          'A product-strategy case study on why technical capability alone is not enough.'
      }
    ]
  },
  ...
  'article/indie-web-monthly-40k-usd-lessons': {
    ...
    relatedLinks: [
      ...
      },
      {
        ...
        href: '/en-US/article/openai-sora-shutdown-10yi-lesson',
        description:
          'Another strategy-focused case study on product, moat, and distribution.'
      },
      {
        title: 'AI Agent Tools Comparison',
        href: '/article/Agent',
  ...
  'en-us/article/openai-sora-shutdown-10yi-lesson': {
    seoTitle:
      'Why OpenAI Shut Down Sora: Product Strategy Lessons From a $1B AI Video Bet',
    seoDescription:
      'Why did OpenAI abandon Sora after the initial hype? This article breaks down the product strategy, distribution, and moat lessons behind one of the most discussed AI video stories in 2026.',
    heroSummary:
      'A product strategy breakdown of why OpenAI walked away from Sora, and what that means for AI video startups.',
    intentTitle: 'Why this case matters',
    intentText:
      'This piece is for founders and AI builders trying to understand why a technically impressive model can still fail to become a durable product moat. The focus is on strategy, distribution, and commercialization, not just model quality.',
    relatedLinks: [
      {
        title: 'AI Agent Tools Comparison',
        href: '/en-US/article/Agent',
        description:
          'Compare FastGPT, Dify, and Coze if you are evaluating AI product stacks.'
      },
      {
        title: 'AI Voice Input Tools 2026',
        href: '/article/voice-input-ai-tools-2026',
        description:
          'Another practical comparison piece focused on product fit and workflow tradeoffs.'
      }
    ]
  },
  ...
  'article/json': {
    seoTitle:
      'LLM JSON Output Guide: How to Get Valid JSON from GPT Reliably in Production Workflows',
    seoDescription:
      'A practical guide to reliable LLM JSON output, covering prompt design, structured output control, validation, and how to make GPT-style models return valid JSON in production workflows.',
    heroSummary:
      'A practical guide to getting valid JSON from LLMs, focused on prompt design, constraints, and output reliability.',
    intentTitle: 'Why this JSON guide matters',
    intentText:
      'This page is for developers searching for how to make GPT output valid JSON, improve structured output accuracy, and build production workflows that depend on machine-readable model responses.',
    relatedLinks: [
      {

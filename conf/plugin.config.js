...
module.exports = {
  // 网站全文搜索
  ALGOLIA_APP_ID: process.env.ALGOLIA_APP_ID || "W8PBKS2O2O", // 在这里查看 https://dashboard.algolia.com/account/api-keys/
  ALGOLIA_ADMIN_APP_KEY: process.env.ALGOLIA_ADMIN_APP_KEY || null, // 管理后台的KEY，不要暴露在代码中，在这里查看 https://dashboard.algolia.com/account/api-keys/
  ALGOLIA_SEARCH_ONLY_APP_KEY:
    process.env.NEXT_PUBLIC_ALGOLIA_SEARCH_ONLY_APP_KEY || "75d5c9e7ac5931fe328ecfe19e8ee664", // 客户端搜索用的KEY

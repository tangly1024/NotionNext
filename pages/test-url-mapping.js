  ...
  return (
    <div className="p-10">
      ...
      <div className="mb-8 p-4 border rounded bg-gray-50">
        ...
        <div className="mb-4">
          <strong>POST_URL_PREFIX:</strong> {testResults?.config?.POST_URL_PREFIX || '未设置'}
        </div>
        
        <div className="mb-4">
          <strong>POST_URL_PREFIX_MAPPING_CATEGORY:</strong>
          <pre className="mt-2 p-2 bg-gray-100 rounded overflow-auto">
            {JSON.stringify(testResults?.config?.POST_URL_PREFIX_MAPPING_CATEGORY || {}, null, 2)}
          </pre>
        </div>
        ...
        <div>
          ...
          <pre className="mt-2 p-2 bg-gray-100 rounded overflow-auto">
            {JSON.stringify(testResults?.config?.sampleCategoryMappings || {}, null, 2)}
          </pre>
        </div>
      </div>
      ...
      <div className="mb-8 p-4 border rounded bg-gray-50">
        ...
        <ol className="list-decimal pl-6">
          <li className="mb-1">在Notion配置中将 <code>POST_URL_PREFIX</code> 设置为 <code>%category%</code></li>
          <li className="mb-1">在Notion配置中添加 <code>POST_URL_PREFIX_MAPPING_CATEGORY</code> 对象，格式如: <code>{"知行合一": "learning"}</code></li>
